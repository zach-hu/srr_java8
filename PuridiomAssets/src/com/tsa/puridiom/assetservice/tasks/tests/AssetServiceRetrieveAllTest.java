...
public class AssetServiceRetrieveAllTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			AssetServiceRetrieveAll test = new AssetServiceRetrieveAll();
			...
			System.out.println("AssetServiceRetrieveAllTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
