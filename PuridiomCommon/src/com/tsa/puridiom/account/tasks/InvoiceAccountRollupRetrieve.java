...
public class InvoiceAccountRollupRetrieve extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "select sum(a.allocAmount), a.fld1,a.fld2,a.fld3,a.fld4,a.fld5,a.fld6,a.fld7,a.fld8,a.fld9,a.fld10,a.fld11,a.fld12,a.fld13,a.fld14,a.fld15, a.accountType "
				+ "from Account as a where a.id.icHeader = ? "
				+ "group by a.fld1,a.fld2,a.fld3,a.fld4,a.fld5,a.fld6,a.fld7,a.fld8,a.fld9,a.fld10,a.fld11,a.fld12,a.fld13,a.fld14,a.fld15, a.accountType";
			...
			if (accountList != null)
			{
			    for (int i=0; i < accountList.size(); i++)
			    {
			        ...
			        String accountType = (String) acctObj[16];

			        AccountRollup acctRollup = new AccountRollup();
			        if (accountType != null && accountType.equalsIgnoreCase("IVU"))
			        {
			        	//bdAllocAmount = bdAllocAmount.negate();
			        	continue;
			        }
