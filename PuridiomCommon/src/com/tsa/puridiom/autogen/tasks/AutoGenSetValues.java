...
public class AutoGenSetValues extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			if (incomingRequest.containsKey("AutoGen_nextNumber"))
			{
				...
				autoGen.setNextNumber(nextNumber);
			}
			...
			if (incomingRequest.containsKey("AutoGen_dateEntered"))
			{
				String dateEnteredString = (String) incomingRequest.get("AutoGen_dateEntered");
				Date dateEntered = Dates.getDate(dateEnteredString);
				autoGen.setDateEntered(dateEntered);
			}
			if (incomingRequest.containsKey("AutoGen_dateExpires"))
			{
				String dateExpiresString = (String) incomingRequest.get("AutoGen_dateExpires");
				Date dateExpires = Dates.getDate(dateExpiresString);
				autoGen.setDateExpires(dateExpires);
			}
