...
public class CatalogItemRetrieveDescription extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "Select CatalogItem.description from CatalogItem as CatalogItem where CatalogItem.id.catalogId = ? and CatalogItem.id.itemNumber = ? ";
