...
public class ChecklistEntryRetrieveAllTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			ChecklistEntryRetrieveAll test = new ChecklistEntryRetrieveAll();
			...
			System.out.println("ChecklistEntryRetrieveAllTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
