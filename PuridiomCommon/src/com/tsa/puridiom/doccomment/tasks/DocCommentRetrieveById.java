...
public class DocCommentRetrieveById extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "from DocComment as DocComment where DocComment.id.icHeader = ? and DocComment.id.icLine = ? and DocComment.id.commentOrder = ? ";
			List resultList = dbs.query(queryString, new Object[] {icHeader, icLine, commentOrder, } , new Type[] { Hibernate.BIG_DECIMAL, Hibernate.BIG_DECIMAL, Hibernate.BIG_DECIMAL}) ;
