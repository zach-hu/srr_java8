...
public class DocCommentWithTextRetrieveByLine extends Task {
	/* (non-Javadoc)
	...
	public Object executeTask(Object object) throws Exception {
		...
		List docCommentList = dbs.query(queryString, new Object[] {bdHeader, bdLine}, new Type[] {Hibernate.BIG_DECIMAL,Hibernate.BIG_DECIMAL}) ;
