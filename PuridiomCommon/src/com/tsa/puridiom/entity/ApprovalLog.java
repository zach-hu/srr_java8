...
public class ApprovalLog implements Serializable {
    ...
    /** identifier field */
    private com.tsa.puridiom.entity.ApprovalLogPK comp_id;
    ...
    private String keepApprover;

    private String keepApprovedFlag;
    ...
    public ApprovalLog(com.tsa.puridiom.entity.ApprovalLogPK comp_id, java.math.BigDecimal amount, java.math.BigDecimal approverAmount, java.lang.String approved, java.lang.String udfValues, java.lang.String authorized, java.lang.String alternateUserid, java.util.Date dateAssigned, java.util.Date dateApproved, java.lang.String approverType, java.lang.String ruleType, java.lang.String poolid, java.lang.String ruleAction, java.lang.String approverSig, java.lang.String callForward, java.lang.String fyiApprover, java.lang.String requiredApprover, java.math.BigDecimal excludeLess, java.lang.String pooldesc, java.lang.String backupApprover, java.lang.String advisor, java.lang.String recommendation, java.lang.String keepApprover, java.lang.String keepApprovedFlag, java.lang.String deferId) {
        ...
        this.keepApprover = keepApprover;
        this.keepApprovedFlag = keepApprovedFlag;
    ...
    /** minimal constructor */
    public ApprovalLog(com.tsa.puridiom.entity.ApprovalLogPK comp_id) {
        this.comp_id = comp_id;
    }

    public com.tsa.puridiom.entity.ApprovalLogPK getComp_id() {
        return this.comp_id;
    }

    public void setComp_id(com.tsa.puridiom.entity.ApprovalLogPK comp_id) {
        this.comp_id = comp_id;
    }
...
//		return (java.sql.Date)HiltonUtility.ckNull(this.dateApproved);
    ...
    public String getKeepApprover() {
        return (java.lang.String)HiltonUtility.ckNull(this.keepApprover).trim();
    }
    public boolean isAnKeepApprover() {
        return this.getKeepApprover().equalsIgnoreCase("Y");
    }
    public void setKeepApprover(String keepApprover) {
    	if (!HiltonUtility.isEmpty(keepApprover) && keepApprover.length() > 1) {
    		keepApprover = keepApprover.substring(0, 1);
		}
        this.keepApprover = keepApprover;
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ApprovalLog) ) return false;
        ApprovalLog castOther = (ApprovalLog) other;
	...
	public String getKeepApprovedFlag() {
		return (java.lang.String)HiltonUtility.ckNull(this.keepApprovedFlag).trim();
	}
	public void setKeepApprovedFlag(String keepApprovedFlag) {
		if (!HiltonUtility.isEmpty(keepApprovedFlag) && keepApprovedFlag.length() > 1) {
			keepApprovedFlag = keepApprovedFlag.substring(0, 1);
		}
        this.keepApprovedFlag = keepApprovedFlag;
	}
