...
public class CatalogComponentPK implements Serializable {
    ...
    /** full constructor */
    public CatalogComponentPK(java.lang.String catalogId, java.lang.String itemNumber, java.math.BigDecimal sequence) {
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("sequenceNum", getSequence())
            .toString();
    }

    public boolean equals(Object other) {
        if ( !(other instanceof CatalogComponentPK) ) return false;
        CatalogComponentPK castOther = (CatalogComponentPK) other;
