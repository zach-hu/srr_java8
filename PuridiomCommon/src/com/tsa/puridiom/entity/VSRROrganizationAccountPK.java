...
public class VSRROrganizationAccountPK implements Serializable {
    ...
    /** full constructor */
    public VSRROrganizationAccountPK(java.lang.String tableType, java.lang.String tableKey) {
        this.tableType = tableType;
        this.tableKey = tableKey;
    }

    /** default constructor */
    public VSRROrganizationAccountPK() {
    }
    ...
    public void setTableType(java.lang.String tableType) {
        if (!HiltonUtility.isEmpty(tableType) && tableType.length() > 4) {
            tableType = tableType.substring(0, 4);
        }
        this.tableType = tableType;
    }
