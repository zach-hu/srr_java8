...
public class VendorCommRelPK implements Serializable {
    ...
    /** full constructor */
    public VendorCommRelPK(java.lang.String vendorId, java.lang.String commodityCode) {
        this.vendorId = vendorId;
        this.commodityCode = commodityCode;
    }

    /** default constructor */
    public VendorCommRelPK() {
    }
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof VendorCommRelPK) ) return false;
        VendorCommRelPK castOther = (VendorCommRelPK) other;
