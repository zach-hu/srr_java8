 ...
 */
public class HistoryLogRetrieveByLine extends Task {
	/* (non-Javadoc)
	...
	public Object executeTask(Object object) throws Exception {
        ...
        String queryString = "from HistoryLog as hst where hst.icHeader = ? and hst.icLine = ? order by hst.icHistory ASC";
		...
		BigDecimal bdLine = new BigDecimal(icHeader);
