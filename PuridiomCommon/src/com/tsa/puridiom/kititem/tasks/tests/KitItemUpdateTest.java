...
public class KitItemUpdateTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			KitItemUpdate kititemupdate = new KitItemUpdate();
			...
			kitItem.setChildQuantity(new BigDecimal(5));
			...
			kititemupdate.executeTask(incomingRequest);
			...
			System.out.println("KitItemUpdateTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
