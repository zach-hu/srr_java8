...
public class AutoAccountingNonCapitalRules extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
        {
	        ...
	        for (Iterator it = requisitionLineList.iterator(); it.hasNext(); )
	        {
	        	...
	        	for (Iterator it2 = accountList.iterator(); it2.hasNext(); )
			    {
					...
					{
						incomingRequest.put("AC01-nocapital", "failed");
					}
					...
					if ( (resultList == null || resultList.size() < 1) || ((Integer)resultList.get(0)).intValue() < 1 )
					{
						incomingRequest.put("AC02-nocapital", "failed");
					}
					...
					if ( (resultList == null || resultList.size() < 1) || ((Integer)resultList.get(0)).intValue() < 1 )
					{
						incomingRequest.put("AC03-nocapital", "failed");
					}
					...
					if ( (resultList == null || resultList.size() < 1) || ((Integer)resultList.get(0)).intValue() < 1 )
					{
						incomingRequest.put("AC04-nocapital", "failed");
					}
					...
					if ( (resultList == null || resultList.size() < 1) || ((Integer)resultList.get(0)).intValue() < 1 )
					{
						incomingRequest.put("AC05-nocapital", "failed");
					}
					...
					if ( (resultList == null || resultList.size() < 1) || ((Integer)resultList.get(0)).intValue() < 1 )
					{
						incomingRequest.put("AC06-nocapital", "failed");
					}
					...
					if ( (resultList == null || resultList.size() < 1) || ((Integer)resultList.get(0)).intValue() < 1 )
        			{
						incomingRequest.put("ENDP-nocapital", "failed");
        			}
					...
					if ( (resultList == null || resultList.size() < 1) || ((Integer)resultList.get(0)).intValue() < 1 )
        			{
        				incomingRequest.put("DIVS-nocapital", "failed");
        			}
		        }
	        }
        }
		catch (Exception e)
		{
            ...
            throw new TsaException("An Error occurred at AutoAccountingNonCapitalRules", e);
		}
		return failed;
    }
}