...
public class VendorDocumentUpdateTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			VendorDocumentUpdate test = new VendorDocumentUpdate();
			...
			vendorDocument.setDocTitle("TEST-SUPPLIER DOCUMENT - UPDATED");
			...
			if (dbs.getStatus() == Status.SUCCEEDED) {
				System.out.println("VendorDocumentUpdateTest SUCCESS");
				dbs.commit();
			}
		
			System.out.println(incomingRequest);
			System.out.println("VendorDocumentUpdateTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
