...
public class CellTable<T> extends AbstractHasData<T> {
  ...
  protected void renderRowValues(SafeHtmlBuilder sb, List<T> values, int start,
    ...
    for (int i = start; i < end; i++) {
      ...
      //sb.append(template.tr(trClasses, new SafeHtmlBuilder().appendHtmlConstant("<td class='GPDXIG2HC GPDXIG2JC'>Jigar</td><td class='GPDXIG2HC GPDXIG2JC'>Jigar</td><td class='GPDXIG2HC GPDXIG2JC'>Jigar</td><td class='GPDXIG2HC GPDXIG2JC'>Jigar</td class='GPDXIG2HC GPDXIG2JC'><td>Jigar</td><td class='GPDXIG2HC GPDXIG2JC'>Jigar</td>").toSafeHtml()));
    }
  }
