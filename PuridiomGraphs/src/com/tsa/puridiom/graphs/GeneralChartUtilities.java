...
public class GeneralChartUtilities
{
...
setLegend(Object) --> addLegend(LegendTitle);
    ...
    public static GeneralGraphParams writeChart(GeneralGraphParams params, JFreeChart chart)
    {
        ...
        try
        {
        	...
        	final File file = new File(filepath(params.getOrganizationId())+ File.separator +filename);
        	ChartUtilities.saveChartAsPNG(file, chart, params.getWidth(), params.getHeigth(),info);
    ...
    public static String formatMe(GeneralGraphParams params, JFreeChart chart)
    {
        params = GeneralChartUtilities.writeChart(params, chart);
        String temp = GeneralChartUtilities.getHtmlSrc(params.getImgName(), params);

        return temp;
    }
    public static String getHtmlSrc(String filename, GeneralGraphParams params)
    {
        ...
        {
        	imageMap = GeneralChartUtilities.getImageMap(filename, params.getChartRenderingInfo());
        }
        ...
        imgTag.append( DictionaryManager.getInstance("host", params.getOrganizationId()).getProperty("item-image-url", "/") );
