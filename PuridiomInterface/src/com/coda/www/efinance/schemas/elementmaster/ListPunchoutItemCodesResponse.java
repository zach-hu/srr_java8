...
public class ListPunchoutItemCodesResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    /* A filter that selects
     *                                 the punchout item codes to be
     *                             listed. */
    private com.coda.www.efinance.schemas.common.ReqKeys filter;

    /* If set to FALSE, it
     *                                 indicates that the Procurement database,
     * in which the punchout items are held,
     *                                 cannot be accessed. If set to TRUE,
     * the
     *                                 Procurement database has been accessed;
     * this means that if nothing is returned,
     *                                 the element does not contain a list
     * of
     *                                 punchout items. */
    private boolean foundDb;

    /* Contains the keys for
     *                                 the punchout item codes
     *                             listed. */
     ...
     *
     * @return filter   * A filter that selects
     *                                 the punchout item codes to be
     *                             listed.
     */
     ...
     *
     * @param filter   * A filter that selects
     *                                 the punchout item codes to be
     *                             listed.
     */
     ...
     *
     * @return foundDb   * If set to FALSE, it
     *                                 indicates that the Procurement database,
     * in which the punchout items are held,
     *                                 cannot be accessed. If set to TRUE,
     * the
     ...
     *
     * @param foundDb   * If set to FALSE, it
     *                                 indicates that the Procurement database,
     * in which the punchout items are held,
     *                                 cannot be accessed. If set to TRUE,
     * the
     ...
     *
     * @return keys   * Contains the keys for
     *                                 the punchout item codes
     *                             listed.
     */
     ...
     *
     * @param keys   * Contains the keys for
     *                                 the punchout item codes
     *                             listed.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster", "ListPunchoutItemCodesResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster", "FoundDb"));
