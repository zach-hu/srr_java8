...
public class GetAddressesResponse  implements java.io.Serializable {
    ...
    /* Contains the element address
     *                             information you have retrieved from the
     * database. */
     ...
     * 
     * @return addresses   * Contains the element address
     *                             information you have retrieved from the
     * database.
     */
     ...
     * 
     * @param addresses   * Contains the element address
     *                             information you have retrieved from the
     * database.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster/elementmaster-6.0/webservice", ">GetAddressesResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster/elementmaster-6.0/webservice", "Addresses"));
