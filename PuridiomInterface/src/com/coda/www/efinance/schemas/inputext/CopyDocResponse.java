...
public class CopyDocResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
     ...
     *
     * @return documentMaster   * The document master
     *                                 of the new document.
     */
     ...
     *
     * @param documentMaster   * The document master
     *                                 of the new document.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "CopyDocResponse"));
