...
public class GetCopyDocParamsResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    /* Contains a key
     *                                 uniquely identifying the new
     *                             document. */
    private com.coda.www.efinance.schemas.transaction.TxnKey key;

    /* The document date of
     *                                 the new document. */
    private java.util.Calendar newDate;

    /* The year/period to
     *                                 which the new document should be
     *                             posted. */
    private java.lang.String newPeriod;

    /* The code of the input
     *                                 template master associated with the
     * new
     *                             document. */
    private java.lang.String inputTemplateCode;

    public GetCopyDocParamsResponse() {
    }
    ...
    /**
     * Gets the key value for this GetCopyDocParamsResponse.
     *
     * @return key   * Contains a key
     *                                 uniquely identifying the new
     *                             document.
     */
    ...
    /**
     * Sets the key value for this GetCopyDocParamsResponse.
     *
    ...
    /**
     * Gets the newDate value for this GetCopyDocParamsResponse.
     *
     * @return newDate   * The document date of
     *                                 the new document.
     */
    ...
    /**
     * Sets the newDate value for this GetCopyDocParamsResponse.
     *
     * @param newDate   * The document date of
     *                                 the new document.
     */
    ...
    /**
     * Gets the newPeriod value for this GetCopyDocParamsResponse.
     *
     * @return newPeriod   * The year/period to
     *                                 which the new document should be
     *                             posted.
     */
    ...
    /**
     * Sets the newPeriod value for this GetCopyDocParamsResponse.
     *
     * @param newPeriod   * The year/period to
     *                                 which the new document should be
     *                             posted.
     */
    ...
    /**
     * Gets the inputTemplateCode value for this GetCopyDocParamsResponse.
     *
    ...
    /**
     * Sets the inputTemplateCode value for this GetCopyDocParamsResponse.
     *
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCopyDocParamsResponse)) return false;
        GetCopyDocParamsResponse other = (GetCopyDocParamsResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCopyDocParamsResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "GetCopyDocParamsResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "NewDate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "NewPeriod"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "InputTemplateCode"));
