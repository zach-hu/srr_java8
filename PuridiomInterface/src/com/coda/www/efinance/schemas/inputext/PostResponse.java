...
public class PostResponse  extends com.coda.www.efinance.schemas.input.PostResponse  implements java.io.Serializable {
    /* Contains details of
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "PostResponse"));
