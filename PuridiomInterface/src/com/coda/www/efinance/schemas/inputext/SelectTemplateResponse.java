...
public class SelectTemplateResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    /* Contains the input
     ...
     * template master. If the input template
     *                                 master is linked to multiple document
     * masters, the document masters are
     *                                 returned in DocCodeList. You should
     * repeat the SelectTemplateRequest,
     *                                 supplying the code of the document
     * master you wish to
     *                             use. */
    private com.coda.www.efinance.schemas.documentmaster.DocumentMaster documentMaster;

    /* Contains the default
     *                                 transaction details as determined
     * by the
     *                                 input template
     *                             master. */
    ...
    /* When the specified
     *                                 input template master is linked to
     * multiple document masters, this element
     *                                 lists the codes of the linked document
     * masters. If this list is returned, you
     *                                 should repeat the SelectTemplateRequest,
     * supplying the code of the document
     *                                 master you wish to
     *                             use. */
     ...
     *
     * @return docCodeList   * When the specified
     *                                 input template master is linked to
     * multiple document masters, this element
     *                                 lists the codes of the linked document
     * masters. If this list is returned, you
     ...
     *
     * @param docCodeList   * When the specified
     *                                 input template master is linked to
     * multiple document masters, this element
     *                                 lists the codes of the linked document
     * masters. If this list is returned, you
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "SelectTemplateResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "DocCodeList"));
