...
public class AutoBalanceTaxResponse  implements java.io.Serializable {
    /* Contains the transaction
     *                             details, including the adjusted tax line. */
    private com.coda.www.efinance.schemas.transaction.Transaction transaction;

    public AutoBalanceTaxResponse() {
    }
    ...
    /**
     * Gets the transaction value for this AutoBalanceTaxResponse.
     * 
    ...
    /**
     * Sets the transaction value for this AutoBalanceTaxResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AutoBalanceTaxResponse)) return false;
        AutoBalanceTaxResponse other = (AutoBalanceTaxResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AutoBalanceTaxResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext/input-11.2/webservice", ">AutoBalanceTaxResponse"));
