...
public class BalancingReviewResponse  implements java.io.Serializable {
    /* Contains results information
     *                             for the BalancingReview request
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext/input-11.2/webservice", ">BalancingReviewResponse"));
