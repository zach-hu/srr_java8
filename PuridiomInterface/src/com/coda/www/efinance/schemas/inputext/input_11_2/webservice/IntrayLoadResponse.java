...
public class IntrayLoadResponse  implements java.io.Serializable {
     ...
     * master, and used when inputting the document. */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext/input-11.2/webservice", ">IntrayLoadResponse"));
