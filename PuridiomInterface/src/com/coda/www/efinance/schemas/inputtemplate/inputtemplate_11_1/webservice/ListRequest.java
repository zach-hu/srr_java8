...
public class ListRequest  implements java.io.Serializable {
     ...
     *                             input templates to be listed. */
    private com.coda.www.efinance.schemas.inputtemplate.ItmReqKeys filter;

    public ListRequest() {
    }

    public ListRequest(
           com.coda.www.efinance.schemas.inputtemplate.ItmReqKeys filter) {
           this.filter = filter;
    }
     ...
     *                             input templates to be listed.
     */
    public com.coda.www.efinance.schemas.inputtemplate.ItmReqKeys getFilter() {
        return filter;
    }
     ...
     *                             input templates to be listed.
     */
    public void setFilter(com.coda.www.efinance.schemas.inputtemplate.ItmReqKeys filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputtemplate/inputtemplate-11.1/webservice", ">ListRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputtemplate", "itmReqKeys"));
