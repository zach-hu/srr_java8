...
public class GetAccessLevelResponse  implements java.io.Serializable {
     ...
     * 
     * @return accessLevel   * The type of access available.
     */
     ...
     * 
     * @param accessLevel   * The type of access available.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction/account-11.2/webservice", ">GetAccessLevelResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction/account-11.2/webservice", "AccessLevel"));
