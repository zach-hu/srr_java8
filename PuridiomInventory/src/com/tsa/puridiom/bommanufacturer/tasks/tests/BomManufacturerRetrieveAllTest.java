...
public class BomManufacturerRetrieveAllTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			BomManufacturerRetrieveAll test = new BomManufacturerRetrieveAll();
			...
			System.out.println("BomManufacturerRetrieveAllTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
