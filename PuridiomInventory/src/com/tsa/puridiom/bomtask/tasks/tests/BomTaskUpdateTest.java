...
public class BomTaskUpdateTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			BomTaskUpdate test = new BomTaskUpdate();
			...
			if (dbs.getStatus() == Status.SUCCEEDED) {
				System.out.println("BomTaskUpdateTest SUCCESS");
				dbs.commit();
			}
		
			System.out.println(incomingRequest);
			System.out.println("BomTaskUpdateTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
