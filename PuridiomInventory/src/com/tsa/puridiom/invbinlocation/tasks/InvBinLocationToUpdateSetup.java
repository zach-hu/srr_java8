 ...
 * com.tsa.puridiom.invbinlocation.tasks.InvBinLocationToUpdateSetup.java
 *
 */
...
public class InvBinLocationToUpdateSetup extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			InvBinLocation bin = (InvBinLocation)incomingRequest.get("toBin");
			incomingRequest.put("invBinLocation", bin);
			incomingRequest.put("binAction", "MOVETO") ;
