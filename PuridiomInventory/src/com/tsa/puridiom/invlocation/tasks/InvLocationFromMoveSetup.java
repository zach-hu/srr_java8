 ...
 * com.tsa.puridiom.invlocation.tasks.InvLocationFromMoveSetup.java
 * 
 */
...
public class InvLocationFromMoveSetup extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			String itemLocation = (String)incomingRequest.get("fromLocation");
