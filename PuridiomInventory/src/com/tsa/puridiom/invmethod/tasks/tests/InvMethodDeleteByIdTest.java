...
public class InvMethodDeleteByIdTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InvMethodDeleteById test = new InvMethodDeleteById();
			...
			if (dbs.getStatus() == Status.SUCCEEDED) {
				System.out.println("InvMethodDeleteByIdTest SUCCESS");
				dbs.commit();
			}
		
			System.out.println(incomingRequest);
			System.out.println("InvMethodDeleteByIdTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
