...
public class InvWorkCenterRetrieveAllTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InvWorkCenterRetrieveAll test = new InvWorkCenterRetrieveAll();
			...
			System.out.println("InvWorkCenterRetrieveAllTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
