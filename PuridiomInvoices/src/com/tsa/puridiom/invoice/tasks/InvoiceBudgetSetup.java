 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class InvoiceBudgetSetup extends Task
{
    ...
    public Object executeTask(Object object) throws Exception
    {
        try
        {
        	...
        	incomingRequest.put("budgetType","INV") ;
            incomingRequest.put("budgetMake","E") ;
            incomingRequest.put("budgetHeaderIc", ivh.getIcIvcHeader().toString()) ;
