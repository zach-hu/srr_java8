...
public class ErrorMsgSetInvoicedReceiptQtyException extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			if (exceptionLineList != null)
			{
	            ...
	            {
	            	message = message + "Line Item #" + exceptionLineList.get(0) + " has created a quantity exception!";
	            }
				//message = message + "  Total Invoiced Quantity is greater than Received Quantity.";
				message = message + "  Invoiced Quantity is greater than Received Quantity.";
			}
