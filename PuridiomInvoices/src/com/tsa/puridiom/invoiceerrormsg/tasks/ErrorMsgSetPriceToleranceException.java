...
public class ErrorMsgSetPriceToleranceException extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			{
				String tolerance = (String) incomingRequest.get("tolerance");
				...
				message = message + "  Dollar Amount not within " + tolerance + "% Variance.";
			}
