...
public class InvoiceVendorAddTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InvoiceVendorAdd test = new InvoiceVendorAdd();
			...
			if (dbs.getStatus() == Status.SUCCEEDED) {
				System.out.println("InvoiceVendorAddTest SUCCESS");
				dbs.commit();
			}
		
			System.out.println(incomingRequest);
			System.out.println("InvoiceVendorAddTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
