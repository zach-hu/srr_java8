...
public class InvoiceVendorRetrieveByTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InvoiceVendorRetrieveBy test = new InvoiceVendorRetrieveBy();
			...
			System.out.println("InvoiceVendorRetrieveByTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
