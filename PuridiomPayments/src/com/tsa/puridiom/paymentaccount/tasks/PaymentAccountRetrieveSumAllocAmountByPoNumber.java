 ...
 * @author Johnny
 */
public class PaymentAccountRetrieveSumAllocAmountByPoNumber extends Task {
	/* (non-Javadoc)
	...
	public Object executeTask(Object object) throws Exception {
		...
		try
		{
	        ...
	        String queryString = "select sum(pa.allocAmount) from PaymentAccount as pa where pa.poNumber = ? ";
