 ...
 */
public class PoConsolidateAutoReleaseFromReqSetup extends Task
{
    ...
    public Object executeTask(Object object) throws Exception
    {
        try
        {
            ...
            if(Utility.isEmpty(newPoHeader.getConfirming())){		newPoHeader.setConfirming("N");		}
            ...
            */
            ...
            String internalCmts = "";
            if(Utility.isEmpty(internalCmts)){	internalCmts = blanket.getInternalComments();		}
            newPoHeader.setInternalComments(internalCmts);
            if(Utility.isEmpty(newPoHeader.getShipViaCode())){		newPoHeader.setShipViaCode(blanket.getShipViaCode());	}
