...
public class PoHeaderRetrieveRequiredBy extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "select PoHeader.requiredDate from PoHeader as PoHeader where PoHeader.icPoHeader = ? ";
