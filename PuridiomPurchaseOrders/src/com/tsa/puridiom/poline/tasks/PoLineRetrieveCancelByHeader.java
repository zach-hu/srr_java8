...
public class PoLineRetrieveCancelByHeader extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "From PoLine as line where line.icPoHeader = ? and line.status <> '9020' and line.lineTotal > 0";
