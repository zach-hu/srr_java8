...
public class DisposInspectionHistoryAddSetup extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			incomingRequest.put("InspectionHistory_icRecLine", incomingRequest.get("InspectionDispos_icRecLine"));
			incomingRequest.put("InspectionHistory_icInspNo", incomingRequest.get("InspectionDispos_icInspNo"));
			incomingRequest.put("InspectionHistory_icMsrLine", incomingRequest.get("InspectionDispos_icMsrLine"));
			incomingRequest.put("InspectionHistory_recType", "Disposition");
			incomingRequest.put("InspectionHistory_quantity", incomingRequest.get("InspectionDispos_dispQuantity"));
