 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class HtmlReceiptsAlerts extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            parameters.put("formType", "html-receipts-alert.jasper");
            parameters.put("PoHeader_requisitionerCode", poHeader.getRequisitionerCode());
