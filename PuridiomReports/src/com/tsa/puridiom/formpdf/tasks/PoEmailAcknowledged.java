 ...
 * @author Kelli
 */
public class PoEmailAcknowledged extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            Log.debug(this, "Setup acknowledged email for po: " + poHeader.getPoNumber());
            ...
            Log.debug(this, "PoEmailAcknowledged [organization : "+ organizationId + "]");
            ...
            parameters.put("formType", "po-email-acknowledged.jasper");
