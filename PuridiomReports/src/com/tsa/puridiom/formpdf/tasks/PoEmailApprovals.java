 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class PoEmailApprovals extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            parameters.put("formType", "po-email-approvals.jasper");
            ...
            List lines =   (List)   poHeader.getPoLineList();
            ...
            List docAttachmentList = poHeader.getDocAttachmentList();
