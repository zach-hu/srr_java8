 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class PrintRecPdf extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            parameters.put("formType", "receiving.jasper");
            ...
            if (organizationId.equalsIgnoreCase("DTN07P"))
				parameters.put("namePdf", poHeader.getPoNumber() + " " + ReceiptType.toString(receiptHeader.getReceiptType(), organizationId) + " [" + receiptHeader.getReceiptNumber() + "].pdf");
			else
