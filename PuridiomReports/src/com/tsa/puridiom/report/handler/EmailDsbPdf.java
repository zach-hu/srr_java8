...
public class EmailDsbPdf
{
    ...
    public Object createMe(String icDsbHeader)
    {
        return this.createMe(icDsbHeader, "N");
    }

    public Object createMe(String icDsbHeader, String TCs)
    {
        String reportName = "";
        Object ret = null;
        try
        {
            ...
            PuridiomProcess process = processLoader.loadProcess("emaildsbpdf.xml");
            Map incomingRequest = new HashMap();
            incomingRequest.put("DisbHeader_icDsbHeader", icDsbHeader);
            ...
            if (process.getStatus() == Status.SUCCEEDED)
            {
                ...
                List attchList = disbHeader.getDocAttachmentList();
                if(attchList != null)
                {
                	if(attchList.size() > 0)
                	{
    ...
    {
    	Log.debug(this, "DSH PDF, " + "getAttachmentName");
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println(pdf.createMe("12923425800081"));
