...
public class RfqLineBids extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			ret = dbs.query(query, new Object[] {icRfqHeader, icRfqHeader, vendorId} , new Type[] { Hibernate.BIG_DECIMAL, Hibernate.BIG_DECIMAL, Hibernate.STRING}) ;
