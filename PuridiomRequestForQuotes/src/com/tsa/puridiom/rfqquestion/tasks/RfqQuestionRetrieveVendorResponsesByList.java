...
public class RfqQuestionRetrieveVendorResponsesByList extends Task {
	public Object  executeTask (Object object) throws Exception {
		...
		try {
			...
			PuridiomProcess process = processLoader.loadProcess("vendorresponse-retrieve-by-rfqquestion.xml");
			...
			for (int i=0; i < rfqQuestionList.size(); i++) {
				...
				if (process.getStatus() < Status.SUCCEEDED) {
					throw new Exception("vendorresponse-retrieve-by-question failed.");
				}
