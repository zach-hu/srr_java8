 ...
 * @author Kelli
 */
public class ApprovalLogAuthorityComparator implements Comparator
{
    private int order = 1;
    ...
    public int compare(Object o1, Object o2)
    {
        if (o1 instanceof ApprovalLog && o2 instanceof ApprovalLog)
        {
            ...
            if (temp == 0)
            {
	            if (log1.isARequiredApprover() && log2.isARequiredApprover())
	            {
	                temp = 0;
	            }
	            else if (log1.isARequiredApprover())
	            {
	                temp = -1;  
	            }
	            else if (log2.isARequiredApprover())
	            {
	                temp = 1;  
	            }
            }
