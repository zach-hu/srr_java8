...
public class QueueCloseRequisitionEmail extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            if(newStatus.equals(DocumentStatus.CLOSED) && !Utility.isEmpty(nextUser))
            {
                ...
                subject.append(" closed") ;
                StringBuffer message = new StringBuffer("Requisition ");
                message.append(requisitionHeader.getRequisitionNumber()) ;
                message.append(" was closed by " + UserManager.getInstance().getUser((String)incomingRequest.get("organizationId"), owner).getDisplayName() );
