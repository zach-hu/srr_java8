...
public class ReqChangeRequestRetrieveAlone extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			"rh.requisitionNumber NOT IN (SELECT ph.requisitionNumber FROM PoHeader ph WHERE ph.requisitionNumber = rh.requisitionNumber " +
