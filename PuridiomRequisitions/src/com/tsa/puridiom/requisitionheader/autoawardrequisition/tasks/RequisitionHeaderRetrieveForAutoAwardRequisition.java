...
public class RequisitionHeaderRetrieveForAutoAwardRequisition extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String additionalFilter = PropertiesManager.getInstance(organizationId).getProperty("AUTOAWARD", "ADDITIONALFILTER", "");

			String queryString = "from RequisitionHeader RequisitionHeader " +
			"WHERE RequisitionHeader.status = ? AND RequisitionHeader.requisitionType = 'P' " + additionalFilter;
