...
public class RequisitionHeaderClone extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			else
			{
				...
				requisitionHeader.setRqSubType("");
				requisitionHeader.setInternalComments("");
			}
			...
			requisitionHeader.setUdf13Code("");
            ...
            if (! propertiesManager.getProperty("FDCS", "Enabled", "N").equalsIgnoreCase("Y")) {
            	...
            	requisitionHeader.setUdf14Code("");
			...
			requisitionHeader.setCurrencyFactor(originalRequisitionHeader.getCurrencyFactor());
			...
			requisitionHeader.setOriginalReqType("");
			requisitionHeader.setCorrosionEval(originalRequisitionHeader.getCorrosionEval());
			requisitionHeader.setWorkOrder("");
			requisitionHeader.setFobCode(originalRequisitionHeader.getFobCode());
			requisitionHeader.setPlannedDate(originalRequisitionHeader.getPlannedDate());
			/*
