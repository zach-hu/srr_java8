...
public class RequisitionHeaderRetrieveCurrencyCode extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "select RequisitionHeader.currencyCode from RequisitionHeader as RequisitionHeader where RequisitionHeader.icReqHeader = ? ";
