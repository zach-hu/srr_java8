 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class RequisitionLineSetShippingTaxFromHeader extends Task
{
    ...
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            boolean headerShipTax = header.getTaxShipping().equals("Y");
            for (Iterator iter = requisitionLineList.iterator(); iter.hasNext();)
            {
                ...
                {
	                line.setTaxShipping("Y");
                }
                else
                {
                    line.setTaxShipping("N");
                }
            }
