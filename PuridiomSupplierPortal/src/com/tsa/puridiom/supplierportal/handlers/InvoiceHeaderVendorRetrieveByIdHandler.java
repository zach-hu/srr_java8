...
public class InvoiceHeaderVendorRetrieveByIdHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("invoiceheader-vendor-retrieve-by-id.xml");
