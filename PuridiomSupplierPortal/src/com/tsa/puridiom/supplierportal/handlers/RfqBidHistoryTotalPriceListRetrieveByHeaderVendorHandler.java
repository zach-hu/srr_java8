...
public class RfqBidHistoryTotalPriceListRetrieveByHeaderVendorHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("rfqbidhistory-totalpricelist-retrieve-by-header-vendor.xml");
