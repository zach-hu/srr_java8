...
public class VendorContactRetrieveByEmailHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("vendor-contact-retrieve-by-email.xml");
