...
public class VendorRegisterUpdateByEmailHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("vendorregister-update-by-email.xml");
