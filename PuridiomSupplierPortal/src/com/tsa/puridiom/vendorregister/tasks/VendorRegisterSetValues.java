...
public class VendorRegisterSetValues extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			if (incomingRequest.containsKey("VendorRegister_contactMobileNumber"))
			{
				String contactMobileNumber = (String) incomingRequest.get("VendorRegister_contactMobileNumber");
				vendorRegister.setContactMobileNumber(contactMobileNumber);
			}
			...
			if (incomingRequest.containsKey("VendorRegister_vendorPrintFaxCode"))
			{
				String vendorPrintFaxCode = (String) incomingRequest.get("VendorRegister_vendorPrintFaxCode");
				vendorRegister.setVendorPrintFaxCode(vendorPrintFaxCode);
			}
