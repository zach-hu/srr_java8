...
import com.tsa.puridiom.supplierportal.menu.MenuManager;
import com.tsa.puridiom.common.documents.RfqInfo;
import com.tsa.puridiom.graphs.*;
...
public final class main_005fmenu_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/menu/graph-data.jsp");
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if (!HiltonUtility.isEmpty(user.getDisplayName())) {
      ...
      out.write("/scripts/dynamicTables.js\"></script>\r\n");
		...
		String fiscalYear = HiltonUtility.getFiscalYear(oid);
		int rfqCount = 0;

      out.write("\r\n\r\n<script language='Javascript1.2' type=\"text/javascript\">\r\n<!--\r\n\tvar recentlybidsolicitations = \"");
      out.print(DictionaryManager.getLabel(oid, "recentlybidsolicitations", "Solicitations I Have Bid On", false));
      out.write("\";\r\n\tvar recentlyclosedsolicitations = \"");
      out.print(DictionaryManager.getLabel(oid, "recentlyclosedsolicitations", "Recently Closed Solicitations", false));
      out.write("\";\r\n\tvar matchingcommodities = \"");
      out.print(DictionaryManager.getLabel(oid, "matchingcommodities", "Solicitations Matching My Commodities", false));
      out.write("\";\r\n\r\n\tvar mysolicitations = \"");
      out.print(DictionaryManager.getLabel(oid, "mysolicitations", "My Solicitations", false));
      out.write("\";\r\n\tvar searchsolicitations = \"");
      out.print(DictionaryManager.getLabel(oid, "searchsolicitations", "Search and review solicitations", false));
      out.write("\";\r\n\tvar searchmatchingcommodities = \"");
      out.print(DictionaryManager.getLabel(oid, "searchmatchingcommodities", "Solicitations matching my commodities", false));
      out.write("\";\r\n\tvar searchrecentlybidsolicitations = \"");
      out.print(DictionaryManager.getLabel(oid, "searchrecentlybidsolicitations", "Search solicitations I have bid on", false));
      out.write("\";\r\n\tvar searchrecentlyclosedsolicitations = \"");
      out.print(DictionaryManager.getLabel(oid, "searchrecentlyclosedsolicitations", "Search recently closed solicitations", false));
      out.write("\";\r\n\r\n\tvar myorders = \"");
      out.print(DictionaryManager.getLabel(oid, "myorders", "My Orders", false));
      out.write("\";\r\n\tvar searchorders = \"");
      out.print(DictionaryManager.getLabel(oid, "searchorders", "Search and review orders", false));
      out.write("\";\r\n\tvar orderspendingack = \"");
      out.print(DictionaryManager.getLabel(oid, "myorderspendingack", "My Orders Pending Acknowledgement", false));
      out.write("\";\r\n\tvar ordersbystatus = \"");
      out.print(DictionaryManager.getLabel(oid, "ordersbystatus", "Purchase Orders", false));
      out.write("\";\r\n\tvar solicitationsbystatus = \"");
      out.print(DictionaryManager.getLabel(oid, "solicitationsbystatus", "Solicitations", false));
      out.write("\";\r\n\r\n\tvar myinvoices = \"");
      out.print(DictionaryManager.getLabel(oid, "myinvoices", "My Invoices", false));
      out.write("\";\r\n\tvar newinvoice = \"");
      out.print(DictionaryManager.getLabel(oid, "newinvoice", "Create a new invoice", false));
      out.write("\";\r\n\tvar searchinvoices = \"");
      out.print(DictionaryManager.getLabel(oid, "searchinvoices", "Search and review invoices", false));
      out.write("\";\r\n\r\n\tvar otheroptions = \"");
      out.print(DictionaryManager.getLabel(oid, "otheroptions", "Other Options", false));
      out.write("\";\r\n\tvar myprofile = \"");
      out.print(DictionaryManager.getLabel(oid, "myprofile", "View My Profile", false));
      out.write("\";\r\n\tvar prequalify = \"");
      out.print(DictionaryManager.getLabel(oid, "prequalify", "Pre-Qualification Process", false));
      out.write("\";\r\n\tvar downloaddocs = \"");
      out.print(DictionaryManager.getLabel(oid, "downloaddocs", "Download Documents", false));
      out.write("\";\r\n\tvar changepswd = \"");
      out.print(DictionaryManager.getLabel(oid, "changepswd", "Change My Password", false));
      out.write("\";\r\n\r\n\tvar surplusoptions = \"");
      out.print(DictionaryManager.getLabel(oid, "surplusoptions", "Surplus Items", false));
      out.write("\";\r\n\tvar searchsurplus = \"");
      out.print(DictionaryManager.getLabel(oid, "searchsurplus", "Search and review surplus auctions", false));
      out.write("\";\r\n\r\n\tvar context = \"");
      out.print(contextPath.substring(1));
      out.write("\";\r\n\r\n\tdocument.write(\"<scr\" + \"ipt language='Javascript1.2' src='");
      out.print(contextPath);
      out.write("/menu/main_menu_arrays.js' type='text/javascript'><\\/scr\" + \"ipt>\");\r\n\tdocument.write(\"<scr\" + \"ipt language='Javascript1.2' src='");
      out.print(contextPath);
      out.write("/menu/main_menu_options.js' type='text/javascript'><\\/scr\" + \"ipt>\");\r\n//-->\r\n</script>\r\n\r\n");
      out.write("\r\n\r\n\r\n");
...
*/
      ...
      out.write("\r\n\r\n<script language='Javascript1.2' type=\"text/javascript\">\r\n<!--\r\n\r\n\tpoStatusGraph = '");
      out.print(poStatusGraph);
      out.write("';\r\n\trfqByStatusGraph = '");
      out.print(rfqByStatusGraph);
      out.write("';\r\n\r\n//-->\r\n</script>");
      out.write("\r\n\r\n<script language='Javascript1.2' type=\"text/javascript\">\r\n<!--\r\n\r\n\tvar bIsQualified = ");
      out.print(user.isQualified());
      out.write(";\r\n\tvar bIsGuest = ");
	...
	if (bidSolicitations != null)
      ...
      out.write("] = new Array(\"");
      out.print(rfqNumber);
      out.write("\", \"javascript: viewRfq('");
      out.print(rfqInfo.getIcRfqHeader());
      out.write("'); void(0);\",\"<span class=raquo>&raquo;</span>\", \"<span style='text-overflow: ellipsis; overflow: hidden; white-space: nowrap; width:300px; position: absolute;'>&nbsp;(");
      out.print(DocumentStatus.toString(rfqInfo.getStatus()));
      out.write(')');
      out.print(rfqDesc);
      out.write("</span>\");\r\n\t\t\t\t\ti++;\r\n");
		}
	...
	if (closedSolicitations != null)
      ...
      out.write("] = new Array(\"");
      out.print(rfqNumber);
      out.write("\", \"javascript: viewClosedRfq('");
      out.print(rfqInfo.getIcRfqHeader());
      out.write("'); void(0);\",\"<span class=raquo>&raquo;</span>\", \"<span style='text-overflow: ellipsis; overflow: hidden; white-space: nowrap; width:300px; position: absolute;'>&nbsp;(");
      out.print(DocumentStatus.toString(rfqInfo.getStatus()));
      out.write(')');
	...
	if (user.isGuest()) {
      ...
      out.write("\");\r\n\t\t\tsetOriginalFilter(\"VendorCommRel_id_vendorId\", \"=\", \"");
      out.print(user.getVendorId());
      out.write("\");\r\n\t\t\tsetOriginalFilter(\"RfqHeader_status\", \"=\", \"2005\");\r\n\t\t\tbrowse(\"rfq-bidboard-posts-by-vendorcomm\");\r\n");
	} else {
      out.write("\r\n\t\t\t//setOriginalFilter(\"RfqHeader_dueDate\", \">=\", \"");
      out.print(HiltonUtility.getFormattedDate(new Date(), oid, "yyyy-MM-dd"));
      out.write("\");\r\n\t\t\tsetOriginalFilter(\"VendorRegCommRel_id_vendorId\", \"=\", \"");
      out.print(user.getVendorId());
	...
	if (user.isGuest()) {
      ...
      out.write("\r\n\t\t\t//setOriginalFilter(\"RfqHeader_dueDate\", \">=\", \"");
      out.print(HiltonUtility.getFormattedDate(new Date(), oid, "yyyy-MM-dd"));
      out.write("\");\r\n\t\t\tsetOriginalFilter(\"RfqVendor_id_vendorId\", \"=\", \"");
      out.print(user.getVendorId());
      ...
      out.print(HiltonUtility.getFormattedDate(rightNow.getTime(), oid, "yyyy-MM-dd"));
      out.write("\");\r\n\t\t\tsetOriginalFilterWithLogicalOper(\"RfqHeader_dueDate\", \"<\", \"");
      out.print(HiltonUtility.getFormattedDate(new Date(), oid, "yyyy-MM-dd"));
