...
public class AutoReleaseNoConsolidateJob extends ScheduledJob
{
	...
	public void getReqLinesToExecute()
	{
		...
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("requisitionline-retrieve-for-autorelease-no-consolidate.xml");
