 ...
 * @author Johnny
 */
public class MscEmailsJob extends ReadInboxJob
{

	public void onStart()
	{
		this.setJobType("mscemail");
	}
	...
	public int processEmail(File emailFile, String subject, String sendFrom, String organizationId)
	{
		...
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("msc-email-process.xml");
		...
		{
			Log.error(this, "MscEmailsJob error " + exception.getMessage());
