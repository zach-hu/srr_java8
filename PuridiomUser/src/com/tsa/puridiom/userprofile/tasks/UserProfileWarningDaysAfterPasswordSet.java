 ...
 * @author kelli
 */
public class UserProfileWarningDaysAfterPasswordSet extends Task
{
	/* (non-Javadoc)
	...
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			else
			{
				...
				try
				{
					daysValid = (Integer.valueOf(PropertiesManager.getInstance(userProfile.getOrganizationId()).getProperty("MISC", "PassExpWarningDays", "0"))).intValue();
