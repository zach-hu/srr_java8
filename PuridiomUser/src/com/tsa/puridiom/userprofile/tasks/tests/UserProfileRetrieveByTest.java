...
public class UserProfileRetrieveByTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			UserProfileRetrieveBy test = new UserProfileRetrieveBy();
			...
			if (list != null) {
				...
				for (int i=0; i < list.size(); i++) {
					...
					if (userProfile == null) {
						System.out.println("UserProfile entity was null.");
					} else {
			...
			System.out.println("UserProfileRetrieveByTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
