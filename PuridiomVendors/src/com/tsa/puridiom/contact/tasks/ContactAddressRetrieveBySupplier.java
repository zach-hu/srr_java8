...
public class ContactAddressRetrieveBySupplier extends Task
{
	/**
	 * Method executeTask.
	 *
	...
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "from Contact as Contact, Address as Address where Contact.id.vendorId = ?" +
											" and Address.id.addressCode = Contact.addressCode and Address.id.addressType = Contact.id.vendorId order by Contact.id.contactCode";
