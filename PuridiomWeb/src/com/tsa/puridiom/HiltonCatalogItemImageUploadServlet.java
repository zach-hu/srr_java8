...
import com.tsa.puridiom.documentfile.tasks.CatalogItemImageUpload;
...
public class HiltonCatalogItemImageUploadServlet extends HiltonServletController {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            incomingRequest.put("documentType", "item-image-path");

            incomingRequest.put("request", request);

            CatalogItemImageUpload uploadImage = new CatalogItemImageUpload();
            uploadImage.executeTask(incomingRequest);
            ...
            incomingRequest.put("CatalogItem_imageFile", filename);
