...
import com.tsa.puridiom.documentfile.tasks.XlsRfqReqPoUploadItems;
...
public class HiltonDocumentXlsUploadServlet extends HiltonServletController {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            XlsRfqReqPoUploadItems upload = new XlsRfqReqPoUploadItems();
            upload.executeTask(incomingRequest);

            String	filename = (String) incomingRequest.get("filename");
            String	queueId = (String) incomingRequest.get("queueId");
