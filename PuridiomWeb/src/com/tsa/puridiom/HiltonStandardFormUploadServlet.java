...
public class HiltonStandardFormUploadServlet extends HiltonServletController {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            incomingRequest.put("documentType", "stdform-document-path");
            ...
            incomingRequest.put("StdAttachment_docFilename", filename);
