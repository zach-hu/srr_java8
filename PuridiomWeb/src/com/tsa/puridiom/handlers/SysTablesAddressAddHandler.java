...
public class SysTablesAddressAddHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			{
				String	errorMsg = (String) incomingRequest.get("duplicateAddressErrorMsg");
				if (errorMsg != null && errorMsg.trim().length() > 0)
				{
					incomingRequest.put("viewPage", incomingRequest.get("duplicateAddressFailurePage"));
				}
				else
				{
