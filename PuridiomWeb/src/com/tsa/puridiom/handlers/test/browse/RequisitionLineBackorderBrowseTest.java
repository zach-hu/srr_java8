...
public class RequisitionLineBackorderBrowseTest
{
	public static void  main (String[] args) throws Exception
	{
		...
		try {
			...
			incomingRequest.put("browseName", "requisitionline-backorder-browse");
			incomingRequest.put("RequisitionLine_itemNumber_filter_sort", "Asc");
