...
public class RequisitionForwardTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			RequisitionForwardHandler test = new RequisitionForwardHandler();
			Map incomingRequest = new HashMap();
			
			incomingRequest.put("organizationId", "PURIDIOM");
			incomingRequest.put("userId", "KELLI");
			incomingRequest.put("RequisitionHeader_icReqHeader", "1379342200000");
