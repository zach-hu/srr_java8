...
<tsa:hidden name="AppPool_poolType" value="C"/>
	...
	<td valign=top width=135px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 valign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12>Catalog Pool</div>
			</td>
		</tr>
		</table>
	</td>
...
<%	} %>
	...
	<td width=50% align=center>
		<div id="pxbutton"><a href="javascript: browse('cat_pool'); void(0);">Cancel</a></div>
	</td>
</tr>
</table>
...
<!-- Hide script
	...
	frm.browseName.value = "cat_pool";
	setNavCookie("/admin/catalog/cat_pool.jsp", "DoNothing", "Catalog Pool <%=appPool.getPoolid()%>");
