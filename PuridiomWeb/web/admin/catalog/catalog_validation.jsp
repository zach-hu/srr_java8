...
<%
	...
	String catalogId = HiltonUtility.ckNull((String) request.getAttribute("Catalog_catalogId"));
%>
	...
	<td valign=top width=135px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 valign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12>Catalog Validation Results</div>
			</td>
		</tr>
		</table>
	</td>
...
<%	if (rules.getResult() == 1) { %>
		<div id="novalidationrules" style="display:none;">
			...
			<tr>
				...
				<td valign=middle class="basic"><b>The Catalog information has passed validation.</b></td>
			 </tr>
			</table>
		</div>
<%	}%>

	<div id="pxbutton"><a tabindex=50 href="javascript: returnToCatalogInformation(); void(0);">Return</a></div>
	</td>
</tr>
</table>
...
<%	} %>
	...
	function returnToCatalogInformation() {
		doSubmit('/admin/catalog/catalog.jsp', 'CatalogRetrieveById');
	}
