...
/*****	SUPPLIER ADDRESS LABELS  ******/
	...
	String	slb_address_line1	= "Business Name / DBA"	;
	String	slb_address_line2	= "Mailing Address"	;
	String	slb_address_line3	= ""		;
	String	slb_address_line4	= ""	;
...
/*****	SUPPLIER COMPANY LABELS  ******/
	...
	String	slb_ein_number		= "Federal Taxpayer ID#"			;
