...
<%
	...
	String	s_commodity = (String) request.getAttribute("Commodity_commodity");
	String tableType = "AC";
	String s_dept_code = "";
	String  s_buyer_code="";
	String labViewGroup = "";
	...
	Account comAccount = null;
	boolean newAccount = false;

	if (accList == null || accList.size() <= 0)
	{
		comAccount = new Account();
		AccountPK comp_id = new AccountPK();
		comp_id.setSequence(new BigDecimal(1));
		comAccount.setComp_id(comp_id);
		comAccount.setDateEntered(d_today);
		comAccount.setDateExpires(d_today);
		comAccount.setOwner(uid);
		comAccount.setStatus("02");
		newAccount = true;
	}
	else
	{
		comAccount = (Account) accList.get(0);
		s_alloc_method = HiltonUtility.ckNull(comAccount.getAllocMethod());
	}
	AccountPK comAccountPK = comAccount.getComp_id();
...
<tsa:hidden name="Commodity_commodity" value="<%=s_commodity%>"/>
<tsa:hidden name="Account_icHeader" value="<%=comAccountPK.getIcHeader()%>"/>
<tsa:hidden name="Account_icLine" value="0"/>
<tsa:hidden name="formType" value="COM"/>
...
<tr>
	...
	<td valign=bottom height=30px width=*>
		...
		<tr>
			<td align=right><b>Commodity:</b></td>
			<td width=100px nowrap><%=s_commodity%></td>
		</tr>
		</table>
...
%>
				<TR>
					<TD ID=acc_num_<%=i%> ALIGN="right"><%=i+1%>
						...
						<tsa:hidden name="Account_accountType" value="COM"/>
...
<tr>
	<td width=50% align=center>
		<div id="pxbutton"><a href="javascript: doSubmit('/admin/systemtables/commodity.jsp', 'ItemAccountUpdate;CommodityRetrieveById;CommodityUpdate'); void(0);">Save</a></div>
	</td>
	<td width=50% align=center>
		<div id="pxbutton"><a href="javascript:  doSubmit('/admin/systemtables/commodity.jsp', 'CommodityRetrieveById'); void(0);">Return</a></div>
	</td>
</tr>
</table>
...
<!-- Hide script
	...
	setNavCookie("/admin/systemtables/commodity_accounts.jsp", "AccountRetrieveByLine", "Commodity Accounts");
