				...
				<tr>
					<td>
						...
						<tr>
							...
							<td width=10% align=center><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "fiscalYear", "Fiscal Year")%></b></td>
...
%>
						<tr>
							...
							<td width=13% align=left class=browseRow nowrap><a href="javascript: viewItem(<%=i%>);void(0);"><%=s_disbNumber%></a><tsa:hidden id="dsbNumber_<%=i%>" name="dsbNumber_<%=i%>" value="<%=b_icDisbHeader%>"/></td>
