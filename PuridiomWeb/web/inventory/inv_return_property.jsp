...
<%
	...
	InvProperty prop = (InvProperty) serialNumbers.get(Integer.parseInt((String)request.getAttribute("indexOfPropertyToEdit")));
%>
...
<tsa:hidden name="indexOfPropertyToEdit" value="${indexOfPropertyToEdit}"/>
					...
					<tr>
						<td>
							...
							<tr <%=HtmlWriter.isVisible(oid, "invprop-serialnumber")%>>
								...
								<td><input type=text name="InvProperty_serialNumber" size=50 maxlength=200 tabindex=6 value="<%=prop.getSerialNumber()%>" onchange="upperCase(this);"></td>
							</tr>
							<tr <%=HtmlWriter.isVisible(oid, "invprop-remarks")%>>
								...
								<td><input type=text name="InvProperty_remarks" size=50 maxlength=50 tabindex=15 value="<%=prop.getRemarks()%>" ></td>
							</tr>
							</table>
						</td>
					</tr>
...
<table border=0 cellpadding=0 cellspacing=0 width=680px>
<tr>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: submitThis(); void(0);">Update</a></div></td>
...
<!-- Hide script
	...
	function submitThis()
	{
		doSubmit('/inventory/inv_return_property_list.jsp', 'InvReturnSetProperty;InvReturnUpdateProperty');
	}
