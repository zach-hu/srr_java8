...
<%	if (s_ivc_status.compareTo(DocumentStatus.IVC_INPROGRESS) == 0 ||  s_ivc_status.equals(DocumentStatus.IVC_APPROVING) || 
		s_ivc_status.compareTo(DocumentStatus.IVC_APPROVED) == 0 || s_ivc_status.compareTo(DocumentStatus.IVC_RECALLED) == 0 ) { %>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: doSubmit('/invoice/iv_items.jsp', 'AccountUpdate;InvoiceHeaderRetrieveById;InvoiceLineRetrieveByHeader'); void(0);">Save</a></div></td>
<%	} else if (s_ivc_status.compareTo(DocumentStatus.IVC_REJECTED) == 0 && user.getVchApp().equalsIgnoreCase("Y")) { %>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: doSubmit('/invoice/iv_items.jsp', 'AccountUpdate;InvoiceHeaderRetrieveById;InvoiceLineRetrieveByHeader'); void(0);">Save</a></div></td>
<%	} %>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: doSubmit('/invoice/iv_items.jsp', 'InvoiceHeaderRetrieveById;InvoiceLineRetrieveByHeader'); void(0);">Return</a></div></td>
</tr>
</table>
