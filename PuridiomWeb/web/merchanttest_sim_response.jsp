...
<%
	String	contextPath = "https://my.puridiom.com/puridiom";
	String	requestURLPath = "https://my.puridiom.com/puridiom/merchanttest_sim_response.jsp";
%>
...
while (names != null && names.hasMoreElements()) {
	...
	out.println(nm + " = " + request.getAttribute(nm)) ;
}
out.println("*******************") ;
...
while (names != null && names.hasMoreElements()) {
	String nm = (String) names.nextElement() ;
	out.println(nm + " = " + request.getParameter(nm)) ;
}
%>
-->
<%
...
<!-- Hide script
	...
	frm.action = "https://my.puridiom.com/puridiom/procure";
