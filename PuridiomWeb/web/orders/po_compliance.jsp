...
<tsa:hidden name="VendorInsurance_contExpires" value="<%=HiltonUtility.getFormattedDate(poHeader.getExpirationDate(),oid, userDateFormat)%>"/>
<tsa:hidden name="VendorInsurance_contEffective" value="<%=HiltonUtility.getFormattedDate(poHeader.getEffectiveDate(), oid, userDateFormat)%>"/>
...
<tr>
	<td valign=top>
						...
						<tr>
							...
							<td <%=HtmlWriter.isVisible(oid, "sup-dateExpiration")%> align=center class=label><tsa:label labelName="sup-dateExpiration" defaultString="Expiration/Review Date" checkRequired="true"/></td>
							<td colspan=2>&nbsp;</td>
						</tr>
						...
						<tr <%=HtmlWriter.isVisible(oid, "sup-certification7")%>>
							...
							<td <%=HtmlWriter.isVisible(oid, "sup-dateCertified")%> align=center nowrap>
								<div id="certifiedDate_7">
									<tsa:input type="text" name="VendorInsurance_certifiedDate7" value="<%=HiltonUtility.getFormattedDate(vendorInsurance.getCertifiedDate7(), oid, userDateFormat)%>" size="12" />
							...
							<td <%=HtmlWriter.isVisible(oid, "sup-certificationStatus")%> align=center>
								<div id="certStatus_7">
									...
									<%	certStatus = vendorInsurance.getCertStatus7();%>
							...
							<td <%=HtmlWriter.isVisible(oid, "sup-SCR7")%> align=center><div id="certUDF_7"><tsa:input type="text" name="VendorInsurance_certUdf7" value="<%=vendorInsurance.getCertUdf7()%>" maxLength="15" /></div></td>
						</tr>
<%} %>
						...
						<tr <%=HtmlWriter.isVisible(oid, "sup-complianceContact")%>>
							...
							<td colspan=4><tsa:input type="text" name="VendorInsurance_certContact" value="<%=vendorInsurance.getCertContact()%>" size="61" /></td>
						</tr>
