...
<tsa:hidden name="VendorInsurance_certifiedDate1" value="<%=HiltonUtility.getFormattedDate(vendorInsurance.getCertifiedDate1(), oid, userDateFormat)%>" />
<tsa:hidden name="VendorInsurance_certStatus1" value="<%=vendorInsurance.getCertStatus1()%>" />
<tsa:hidden name="VendorInsurance_certUdf1" value="<%=vendorInsurance.getCertUdf1()%>" />
<tsa:hidden name="VendorInsurance_certifiedDate2" value="<%=HiltonUtility.getFormattedDate(vendorInsurance.getCertifiedDate2(), oid, userDateFormat)%>" />
<tsa:hidden name="VendorInsurance_certStatus2" value="<%=vendorInsurance.getCertStatus2()%>" />
<tsa:hidden name="VendorInsurance_certUdf2" value="<%=vendorInsurance.getCertUdf2()%>" />
<tsa:hidden name="VendorInsurance_certifiedDate3" value="<%=HiltonUtility.getFormattedDate(vendorInsurance.getCertifiedDate3(), oid, userDateFormat)%>" />
<tsa:hidden name="VendorInsurance_certStatus3" value="<%=vendorInsurance.getCertStatus3()%>" />
<tsa:hidden name="VendorInsurance_certUdf3" value="<%=vendorInsurance.getCertUdf3()%>" />
<tsa:hidden name="VendorInsurance_certifiedDate4" value="<%=HiltonUtility.getFormattedDate(vendorInsurance.getCertifiedDate4(), oid, userDateFormat)%>" />
<tsa:hidden name="VendorInsurance_certStatus4" value="<%=vendorInsurance.getCertStatus4()%>" />
<tsa:hidden name="VendorInsurance_certUdf4" value="<%=vendorInsurance.getCertUdf4()%>" />
<tsa:hidden name="VendorInsurance_certifiedDate5" value="<%=HiltonUtility.getFormattedDate(vendorInsurance.getCertifiedDate5(), oid, userDateFormat)%>" />
<tsa:hidden name="VendorInsurance_certStatus5" value="<%=vendorInsurance.getCertStatus5()%>" />
<tsa:hidden name="VendorInsurance_certUdf5" value="<%=vendorInsurance.getCertUdf5()%>" />
<tsa:hidden name="VendorInsurance_certifiedDate6" value="<%=HiltonUtility.getFormattedDate(vendorInsurance.getCertifiedDate6(), oid, userDateFormat)%>" />
<tsa:hidden name="VendorInsurance_certStatus6" value="<%=vendorInsurance.getCertStatus6()%>" />
<tsa:hidden name="VendorInsurance_certUdf6" value="<%=vendorInsurance.getCertUdf6()%>" />
<tsa:hidden name="VendorInsurance_certContact" value="<%=vendorInsurance.getComplianceContact()%>" />
<tsa:hidden name="VendorInsurance_complianceNotes" value="<%=vendorInsurance.getComplianceNotes()%>" />
...
<%@ include file="/base/vendorins_coverage_options.jsp" %>
			...
			<%} else {%>
					<td <%=HtmlWriter.isVisible(oid, "sup-nameInsured")%> align=center>
						<input type=checkbox name="ckbox" value="Y"<% if (vendorInsurance.getNamed1().equals("Y")) {%>checked<%}%> onclick="setFlagFromCkbox(this, frm.VendorInsurance_named4); void(0);">
...
<%@ include file="/base/vendorins_coverage_options.jsp" %>
			...
			<%} else {%>
					<td <%=HtmlWriter.isVisible(oid, "sup-nameInsured")%> align=center>
						<input type=checkbox name="ckbox" value="Y"<% if (vendorInsurance.getNamed1().equals("Y")) {%>checked<%}%> onclick="setFlagFromCkbox(this, frm.VendorInsurance_named5); void(0);">
