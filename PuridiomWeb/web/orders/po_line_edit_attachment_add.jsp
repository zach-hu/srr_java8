...
try{
	...
	String s_po_doc_ic = HiltonUtility.ckNull((String)request.getAttribute("DocAttachment_edit_docIc"));
%>
...
<input type="hidden" name="DocAttachment_docIc" value="<%=s_po_doc_ic%>"/>
...
<!--  hide script from old browsers
	...
	doSubmit('/orders/po_line_attachments.jsp', 'DocAttachmentUpdateById;DocAttachmentRetrieveByLine');
