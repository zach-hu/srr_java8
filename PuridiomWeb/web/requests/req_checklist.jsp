	...
	<td valign=top width=135px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 valign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12><tsa:label labelName="orderChecklist" defaultString="Order Checklist" /></div>
			</td>
		</tr>
		</table>
	</td>
...
<tr>
	<td valign=top align=center>
		...
		<tr valign=middle>
			...
			<td width=6%><b><u><tsa:label labelName="yes" defaultString="Yes" /></u></b></td>
			<td width=6%><b><u><tsa:label labelName="no" defaultString="No" /></u></b></td>
			<td width=6%><b><u><tsa:label labelName="n/a" defaultString="N/A" /></u></b></td>
			<td width=70%>&nbsp;</td>
		</tr>
<%
...
<%		}
	...
	if (i_qstrows == 0) {%>
		<tr>
			<td>&nbsp;</td>
			<td align=center colspan=5>&nbsp;<b><tsa:label labelName="checklistNotSetUp" defaultString="A checklist has not yet been set up" />.</b></td>
		</tr>
<%	} %>
		</table>
	</td>
