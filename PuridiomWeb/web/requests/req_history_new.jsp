...
<tr>
	<td width=100% align=center valign=top>
		...
		<tr class=mnav height=18px>
			<td nowrap class=mnav><tsa:label labelName="dateTime" defaultString="Date/Time" /></td>
			<td width=15px class=mnav>&nbsp;</td>
...
%>
		<tr height=18px>
			<td colspan=5 align=center><b><tsa:label labelName="there-is-no-history" defaultString="There is no history available at this time" />!</b></td>
		</tr>
<%
		}
%>
