...
<%
	...
	String  s_req_doc_ic = (String)request.getAttribute("DocAttachment_edit_docIc");
...
<!--  hide script from old browsers
	...
	doSubmit('/requests/req_line_attachments.jsp', 'DocAttachmentUpdateById;DocAttachmentRetrieveByLine');
