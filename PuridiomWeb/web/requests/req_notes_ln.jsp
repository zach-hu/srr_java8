...
<tsa:hidden name="DocComment_icLine" value="<%=s_req_ic_line%>"/>
	...
	<% if (s_req_type.equals("M")) { %>
		<tsa:tr>
			<tsa:td noWrap="nowrap" cssClass="hdr12" valign="middle">
				<div style="margin-left:10px; margin-right:10px" class=hdr12><tsa:label labelName="req-type" defaultString="Req Type"/>&nbsp;<tsa:label labelName="lineItem" defaultString="Line Item"/> <%=s_line_number%> - <tsa:label labelName="comments" defaultString="Comments"/></div>
			</tsa:td>
		</tsa:tr>
	<% } else { %>
		<tsa:tr>
				...
				<tsa:td valign="top">
					...
					<tsa:tr>
						<tsa:td>
							...
							<tsa:tr>
<%		if (s_req_status.compareTo(DocumentStatus.REQ_FORWARDED) < 0 || s_req_status.compareTo(DocumentStatus.RFQ_PRICED) == 0 || s_req_status.compareTo(DocumentStatus.TEMPLATE) == 0) { %>
								<tsa:td width="50%" align="center"><div id="pxbutton"><a href="javascript: populateCmt(); void(0);">Save</a></div></tsa:td>
								<tsa:td width="50%" align="center"><div id="pxbutton"><a href="javascript: cancelEdit(); void(0);">Return</a></div></tsa:td>
<%		} else {%>
								<tsa:td width="100%" align="center"><div id="pxbutton"><a href="javascript: cancelEdit(); void(0);">Return</a></div></tsa:td>
<%		}%>
							</tsa:tr>
							</table>
						</tsa:td>
...
<tsa:tr>
<%		if (s_req_status.compareTo(DocumentStatus.REQ_FORWARDED) < 0 || s_req_status.compareTo(DocumentStatus.RFQ_PRICED) == 0 || s_req_status.compareTo(DocumentStatus.TEMPLATE) == 0) { %>
	<tsa:td width="50%" align="center"><div id="pxbutton"><a href="javascript: doSubmit('/requests/req_item.jsp', 'DocCommentUpdate;RequisitionLineRetrieve'); void(0);">Save</a></div></tsa:td>
	<tsa:td width="50%" align="center"><div id="pxbutton"><a href="javascript: doSubmit('/requests/req_item.jsp', 'RequisitionLineRetrieve'); void(0);">Return</a></div></tsa:td>
<%		} else {%>
	<tsa:td width="100%" align="center"><div id="pxbutton"><a href="javascript: doSubmit('/requests/req_item.jsp', 'RequisitionLineRetrieve'); void(0);">Return</a></div></tsa:td>
<%		}%>
</tsa:tr>
</table>
</div>
