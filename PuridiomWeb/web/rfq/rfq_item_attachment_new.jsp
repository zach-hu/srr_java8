...
try{
	...
	String s_ic_rfq_line = (String) request.getAttribute("RfqLine_icRfqLine");
	String	returnPage = "";
...
<tsa:hidden name="DocAttachment_icLine" value="<%=s_ic_rfq_line%>"/>
<tsa:hidden name="DocAttachment_docIc" value=""/>
<tsa:hidden name="DocAttachment_docSource" value="RFL"/>
<tsa:hidden name="DocAttachment_docPrint" value="N"/>
<tsa:hidden name="DocAttachment_docPost" value="N"/>
<tsa:hidden name="returnPage" value="/rfq/rfq_line_attachments.jsp"/>
<tsa:hidden name="returnHandler" value="DocAttachmentRetrieveByLine"/>

<tsa:hidden name="RfqLine_icRfqLine" value="<%=s_ic_rfq_line%>"/>
...
<%		}%>
		...
		<tr>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: doSubmit('/rfq/rfq_line_attachment_add.jsp', '--'); void(0);">Add</a></div></td>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: doSubmit('/rfq/rfq_line_attachments.jsp', 'DocAttachmentRetrieveByLine'); void(0);">Return</a></div></td>
		</tr>
		</table>
	</td>
</tr>
