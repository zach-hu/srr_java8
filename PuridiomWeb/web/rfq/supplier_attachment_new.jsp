...
<tr>
	<td valign=top align=center width=100%>
		...
		<tr>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: doSubmit('/rfq/supplier_attachment_add.jsp', '--'); void(0);">Add</a></div></td>
	<td width=50% align=center><div id="pxbutton"><a href="javascript: doSubmit('/rfq/supplier_attachments.jsp', 'VendorDocumentRetrieveByVendor'); void(0);">Return</a></div></td>
		</tr>
		</table>
	</td>
</tr>
