	...
	<td valign=top width=135px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 valign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12><%=attachmentType%> Documents</div>
			</td>
		</tr>
		</table>
	</td>
...
<%		}%>
			...
			<tr>
				<td colspan=4 valign=top>
					...
					<tr><td width=100% align=center><br>There are currently no <%=attachmentType.toLowerCase()%> documents attached.<br></td></tr>
					</table>
					</div>
