...
<%
String	s_title = "Supplier BidHistory for all Items";
List totalPricesList = (List) request.getAttribute("totalPricesList");
RfqBidHistoryVendorGraphData vendorData = new RfqBidHistoryVendorGraphData(totalPricesList,"test","ACME");
...
params.setXTitle("Month");
params.setYTitle("Total Price");
