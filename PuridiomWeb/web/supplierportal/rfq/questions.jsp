...
%>
				<tr>
					...
					<td class=summary>
						...
						<tsa:hidden name="VendorResponse_vendorId" value="<%=user.getVendorId()%>"/>
...
<%	} %>
		...
		<tr>
			<td align=center width=50%>
				<a href="javascript: doSubmit('/system/close_window.jsp', 'VendorResponseUpdate'); void(0);"><img tabindex=30 src="<%=contextPath%>/supplierportal/images/button_save.gif" class=button border=0></a>
			</td>
			<td align=center width=50%>
				<a href="javascript: this.close(); void(0);"><img tabindex=31 src="<%=contextPath%>/supplierportal/images/button_close.gif" class=button border=0></a>
			</td>
		</tr>
		</table>
	</td>
...
<!--  hide script from old browsers
	...
	function validateForm() {
		...
		opener.frm.as_survey_complete.value = surveyComplete;
