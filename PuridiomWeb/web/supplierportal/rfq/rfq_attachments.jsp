<%	if (rfqAttachmentList != null && rfqAttachmentList.size() > 0) {%>
	<tr><td colspan=2><br></td></tr>
	<tr>
		<td valign=top><b>Attachments:</b></td>
		<td colspan=5>
			<table border=0 cellspacing=0 cellpadding=2 width=100% class=summary id="attachments">
	<%	for(int i = 0; i < rfqAttachmentList.size(); i++) {
				DocAttachment docAttachment = (DocAttachment) rfqAttachmentList.get(i);
