...
<%
  ...
  PropertiesManager.getInstance(oid);
%>
...
<tr>
  <td align="center" valign="top" width="500px" id="systemSetupFrame">
    <div id="SystemProcessing" style="visibility: visible; position:absolute; top:150px; left:25px; height:400px;">
      ...
      <tr>
        <td width="100%" align="center" valign="top"><b>Reloading Properties... Please wait.</b><br><br><br><img src="<%=contextPath%>/images/processing.gif" border=1 width=200px height=15px></td>
      </tr>
      </table>
    </div>
    <div id="SystemProcessingComplete" style="visibility: hidden; display: none; position:absolute; top:150px; left:25px; height:400px;">
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr>
			<td width="100%" align="center" valign="top"><b>COMPLETE - Properties, Rules, and Labels have been reloaded.</b></td>
		</tr>
		</table>
		<br>
