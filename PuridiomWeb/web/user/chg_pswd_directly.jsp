...
<%
	...
	errorMsg = errorMsg + "<br>The password should be between " + PropertiesManager.getInstance(oid).getProperty("MISC","PASSLENGTH","1") + " and 12 characters.";
...
<tr>
	<td align=center colspan=2>
		...
		<tr>
			<td width="50%" align=center><div id="pxbutton"><a href="javascript: doSubmit('<%=headerEncoder.encodeForJavaScript(returnPage)%>', 'UserChangePasswordDirectly'); void(0);" tabindex="3">Save</a></div></td>
...
<!-- Hide script
	...
	function validateForm() {
		if (frm.handler.value.indexOf("UserChangePasswordDirectly") >= 0) {
			var alertMessage = "";
			var w;
