...
public class TelephoneNumber implements Serializable {
	...
	private void setContent(Element telephoneNumberElement,
		...
		if (telephoneNumberObject.getAreaOrCityCode() != null)
		{
			areaOrCityCode = telephoneNumberObject.getAreaOrCityCode().toString();
		}
		
		telephoneNumberElement.addContent(new Element(
				Params.AREA_OR_CITY_CODE_ELEMENT).setText(areaOrCityCode));
