...
public class AssetRetrieveByCancelCheckBox extends Task
{
	/**
	 * Method executeTask.
	 * @param object <p>incomingRequest</p>
	 * @author EDSAC
	 * return a Asset_tagNumber list
	 */
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			{
				String generateValue = (String) incomingRequest.get("Asset_cancelTag"+Asset_tagNumber[i]);
