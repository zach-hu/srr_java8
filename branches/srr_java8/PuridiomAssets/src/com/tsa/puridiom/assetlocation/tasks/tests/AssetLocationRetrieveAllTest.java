...
public class AssetLocationRetrieveAllTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			AssetLocationRetrieveAll test = new AssetLocationRetrieveAll();
			...
			System.out.println("AssetLocationRetrieveAllTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
