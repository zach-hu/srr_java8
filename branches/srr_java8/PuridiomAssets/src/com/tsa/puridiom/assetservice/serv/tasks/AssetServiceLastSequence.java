...
public class AssetServiceLastSequence extends Task
{
	/**
	 * Method executeTask.
	 *
	...
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			String sql = "Select MAX(AssetService.id.sequenceNo) from AssetService AssetService Where AssetService.id.tagNumber = ?";
			List resultList = dbs.query(sql, new Object[] {AssetService_tagNumber} , new Type[] { Hibernate.STRING});
