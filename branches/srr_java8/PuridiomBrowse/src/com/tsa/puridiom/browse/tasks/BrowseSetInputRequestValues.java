...
public class BrowseSetInputRequestValues extends Task {
				    ...
				    if (browseColumn.storeRequestValue()) {
					    ...
					    if (incomingRequest.containsKey(columnName)) {
					        ...
					        if (inputValueObject instanceof String[]) {
					            ...
					            Map	keyMap = BrowseUtility.getColumnKeyValue(browseKeys, pageResultsList.get(0), organizationId, browseColumns, browseId, userDateFormat, browseColumn.getColumnName());
