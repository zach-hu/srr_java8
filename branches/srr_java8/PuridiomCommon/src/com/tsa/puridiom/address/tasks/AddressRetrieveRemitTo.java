...
public class AddressRetrieveRemitTo extends Task
{
	/**
	 * Method executeTask.
	 *
	...
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "from Address as Address where Address.id.addressType = ? and Address.id.addressCode = 'REMITTO' ";
