...
public class CatalogItemRetrieveImageFile extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "select CatalogItem.imageFile from CatalogItem as CatalogItem where CatalogItem.id.catalogId = ? and CatalogItem.id.itemNumber = ? ";
