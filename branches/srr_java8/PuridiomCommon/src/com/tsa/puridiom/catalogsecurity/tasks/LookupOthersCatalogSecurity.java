...
public class LookupOthersCatalogSecurity extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		List resultList = null;
		Object result = "F";//FALSE
		try {
			Log.debug(this, ">>>>>>>>>>>>>>> Begin --> LookupOthersCatalogSecurity" );
			...
			if (resultList != null && resultList.size() > 0)
			{
				...
				queryString =
					"Select CatalogSecurity.catalogId " +
					"from CatalogSecurity CatalogSecurity " +
					"where CatalogSecurity.catalogId = '" + catalogId + "' )";
				resultList = dbs.query(queryString);
				if (resultList != null && resultList.size() > 0)
				{
					result = "M";//Maybe
			...
			Log.debug(this, "Error on LookupOthersCatalogSecurity: \r\n" + e.getMessage());
			e.printStackTrace();
			throw e;
		}
		return result ;
