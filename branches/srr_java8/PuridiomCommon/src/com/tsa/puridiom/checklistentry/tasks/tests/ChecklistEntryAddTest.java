...
public class ChecklistEntryAddTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			ChecklistEntryAdd test = new ChecklistEntryAdd();
			...
			if (dbs.getStatus() == Status.SUCCEEDED) {
				System.out.println("ChecklistEntryAddTest SUCCESS");
				dbs.commit();
			}
		
			System.out.println(incomingRequest);
			System.out.println("ChecklistEntryAddTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
