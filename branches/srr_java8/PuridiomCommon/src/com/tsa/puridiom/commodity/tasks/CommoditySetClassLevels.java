 ...
 */
public class CommoditySetClassLevels extends Task {
	...
	public Object  executeTask (Object object) throws Exception {
		...
		if (commodityCodes.length == 1) {
			incomingRequest.put("Commodity_nigplevel", nigpLevels[0]);
			incomingRequest.put("Commodity_level1", commodityLevels[0][0]);
			incomingRequest.put("Commodity_level2", commodityLevels[1][0]);
			incomingRequest.put("Commodity_level3", commodityLevels[2][0]);
		} else {
			incomingRequest.put("Commodity_nigplevel", nigpLevels);
			incomingRequest.put("Commodity_level1", commodityLevels[0]);
			incomingRequest.put("Commodity_level2", commodityLevels[1]);
			incomingRequest.put("Commodity_level3", commodityLevels[2]);
		}
