...
public class ApprovalLogPK implements Serializable {
    ...
    /** full constructor */
    public ApprovalLogPK(java.math.BigDecimal icHeader, java.math.BigDecimal icLine, java.math.BigDecimal sequence, java.lang.String userId) {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ApprovalLogPK) ) return false;
        ApprovalLogPK castOther = (ApprovalLogPK) other;
