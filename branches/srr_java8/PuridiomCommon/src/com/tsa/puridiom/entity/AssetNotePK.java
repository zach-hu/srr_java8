...
public class AssetNotePK implements Serializable {
    ...
    /** full constructor */
    public AssetNotePK(BigDecimal sequenceNo, java.lang.String tagNumber)
    {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof AssetNotePK) ) return false;
        AssetNotePK castOther = (AssetNotePK) other;
