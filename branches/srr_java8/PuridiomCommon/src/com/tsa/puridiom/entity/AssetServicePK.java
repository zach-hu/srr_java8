...
public class AssetServicePK implements Serializable {
    ...
    /** full constructor */
    public AssetServicePK(BigDecimal sequenceNo, java.lang.String tagNumber)
    {
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof AssetServicePK) ) return false;
        AssetServicePK castOther = (AssetServicePK) other;
