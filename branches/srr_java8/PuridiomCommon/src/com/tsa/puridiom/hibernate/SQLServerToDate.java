 ...
 *
 */
public class SQLServerToDate implements SQLFunction {
	...
	public String render(List args, SessionFactoryImplementor factory)
		...
		if (args.size() != 2) {
			throw new IllegalArgumentException("the function must be passed 2 argument");
		}

		StringBuffer buffer = new StringBuffer("CAST(") ;
		buffer = buffer.append(args.get(0).toString()) ;
