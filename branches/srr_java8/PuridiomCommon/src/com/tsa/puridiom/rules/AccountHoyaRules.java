...
public class AccountHoyaRules extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
        {
	        ...
	        for (Iterator it = requisitionLineList.iterator(); it.hasNext(); )
	        {
	        	...
	        	for (Iterator it2 = accountList.iterator(); it2.hasNext(); )
			    {
					...
					if ( !HiltonUtility.isEmpty(fld5) || requisitionLine.getAsset().equals("Y") )
					{
		...
		catch (Exception e)
		{
            ...
            throw new TsaException("An Error occurred at AccountHoyaRules", e);
		}
		return result;
    }
}