 ...
 * @author Johann
 */
public class ValidAccountsRules extends Task
{
	/*
	 * (non-Javadoc)
	 * 
	...
	public void validGlAccountForItRequisition(RequisitionHeader header, List lineItems, Map incomingRequest)
	{
		...
		{
			validGLAccount = this.isValidGLAccount(header, header.getAccountList(), incomingRequest);
		}
	...
	private String isValidGLAccount(RequisitionHeader header, List accounts, Map incomingRequest)
	{
