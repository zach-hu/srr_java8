 ...
 */
public class CatalogItemImageUpload extends Task {
...
//            String  catalogName = incomingArray[1];
            ...
            String catalogName = multi.getParameter("CatalogItem_id_catalogId");

            dirName = dirName + File.separator + catalogName;

            File catalogFile = new File(dirName);
