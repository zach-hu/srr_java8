...
public class EditDocument extends Task {
		...
		try {
            ...
            if (files.hasMoreElements()) {
                ...
                if (f != null)
                {
                    ...
                    String queueId = this.SendQueueAddXls(organizationId, formType, icHeader, fileToName, userI);
                    incomingRequest.put("queueId", queueId);
                    result = nameto;
                }
            }
    ...
    public String SendQueueAddXls(String organizationID, String formType, String icHeader, String fileName, String userI) {
    	...
    	try {
    	    ...
    	    PuridiomProcessLoader processLoader = new PuridiomProcessLoader(organizationID);
      	    ...
      	    UserProfile user = UserManager.getInstance().getUser(organizationID,userI);
        	...
        	incomingRequest.put("SendQueue_action","UI");
        	incomingRequest.put("SendQueue_subject",fileName);
        	incomingRequest.put("SendQueue_doctype",formType);
        	incomingRequest.put("SendQueue_sendto",mailId);
        	incomingRequest.put("SendQueue_owner",userI);

        	process.executeProcess(incomingRequest);

            this.setStatus(process.getStatus());

            queueId=(String)incomingRequest.get("SendQueue_queueid");

        	//System.out.println("El Registro SendQueueAddXls fue añadido en BD Exitosamente...");
    	  ...
    	  {
    		e.printStackTrace();
    		//System.out.println("El Registro SendQueueAddXls en BD Fallo...");
