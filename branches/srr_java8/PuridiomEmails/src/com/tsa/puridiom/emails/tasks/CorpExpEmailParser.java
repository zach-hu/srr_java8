 ...
 * @author Johnny
 */
public class CorpExpEmailParser extends Task
{
	private final String REGEX_SUBJECT_PREFIX = "Corporate Express(.)+Order(.)+";
	...
	public Object executeTask(Object object) throws Exception
	{
		...
		} catch (Exception exception)
		{
			...
			Log.error(this, "CorpExpEmailParser error " + exception.getMessage());
	...
	private PoHeader retrieveOrder(String subject, String organizationId) throws Exception
	{
		...
		{
			String[] tokens = subject.split("Order");
			...
			for (int i = 0; i < documentTokens.length; i++)
			{
				...
				{
					String[] number = documentToken.substring(1).split("/");
