 ...
 * @author Johnny
 */
public class MscEmailParser extends Task
{
	private final String REGEX_SUBJECT_PREFIX = "((Order Acknowledgement)(.)+)|((Shipping Acknowledgement)(.)+)";
	...
	private PoHeader retrieveOrder(String subject, String organizationId) throws Exception
	{
		...
		if (subject.matches(REGEX_SUBJECT_PREFIX))
		{
