...
public class RequisitionerReqCountGraphData extends GraphData
{
    ...
    public RequisitionerReqCountGraphData(Map incomingRequest)
    {
    ...
    {
    	this.setReqData((List)incomingRequest.get("requisitionActions"));
    }

    public CategoryDataset getDataset(GraphParams params)
    {
        List data = this.getReqData();
    ...
    private CategoryDataset createStackedDataset() throws NoDataException
    {
        ...
        while (iter.hasNext())
        {
            ...
            ad[i][0] = ((Long)valuesTemp[0]).doubleValue();
