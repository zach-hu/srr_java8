...
public class GetResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    ...
    /**
     * Gets the UDFMaster value for this GetResponse.
     *
    ...
    /**
     * Sets the UDFMaster value for this GetResponse.
     *
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/common/schemas/udfmaster", "GetResponse"));
