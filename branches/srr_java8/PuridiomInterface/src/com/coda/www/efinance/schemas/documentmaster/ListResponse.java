...
public class ListResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    /* The filter that was
     *                                 used to select the document masters
     * to
     *                                 be listed. */
    private com.coda.www.efinance.schemas.documentmaster.PrintDocSelectKey filter;

    /* Contains the key
     *                                 information for the listed document
     * masters. */
    ...
    public ListResponse(
           ...
           com.coda.www.efinance.schemas.documentmaster.PrintDocSelectKey filter,
     ...
     *                                 be listed.
     */
    public com.coda.www.efinance.schemas.documentmaster.PrintDocSelectKey getFilter() {
        return filter;
    }
     ...
     *                                 be listed.
     */
    public void setFilter(com.coda.www.efinance.schemas.documentmaster.PrintDocSelectKey filter) {
        this.filter = filter;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/documentmaster", "ListResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("filter");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/documentmaster", "Filter"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/documentmaster", "PrintDocSelectKey"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("keys");
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/documentmaster", "Keys"));
