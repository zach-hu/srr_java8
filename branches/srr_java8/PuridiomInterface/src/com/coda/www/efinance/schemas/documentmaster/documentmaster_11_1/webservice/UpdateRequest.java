...
public class UpdateRequest  implements java.io.Serializable {
     ...
     *                             the document master you want to update. */
    ...
    /**
     * Gets the documentMaster value for this UpdateRequest.
     * 
    ...
    /**
     * Sets the documentMaster value for this UpdateRequest.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/documentmaster/documentmaster-11.1/webservice", ">UpdateRequest"));
