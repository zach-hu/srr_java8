...
public class UpdateResponse  extends com.coda.www.efinance.schemas.common.MultiCompanyResponse  implements java.io.Serializable {
     ...
     *                                 which the updated element filter master
     * applies. */
    private short level;
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementfiltermaster", "UpdateResponse"));
