...
public class FetchResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    /* The code for the
    ...
    /* The level of the
     *                                 element whose information you attempted
     * to fetch. */
    private short level;

    /* The code for the
     *                                 element master whose information you
     * attempted to fetch. */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster", "FetchResponse"));
