...
public class GetBanksResponse  implements java.io.Serializable {
     ...
     * 
     * @return banks   * Contains the element bank
     *                             information you have retrieved from the
     * database.
     */
     ...
     * 
     * @param banks   * Contains the element bank
     *                             information you have retrieved from the
     * database.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster/elementmaster-6.0/webservice", ">GetBanksResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster/elementmaster-6.0/webservice", "Banks"));
