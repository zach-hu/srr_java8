...
public class GetResponse  implements java.io.Serializable {
     ...
     * 
     * @return element   * Contains the element master
     *                             you have retrieved from the database.
     */
     ...
     * 
     * @param element   * Contains the element master
     *                             you have retrieved from the database.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/elementmaster/elementmaster-6.0/webservice", ">GetResponse"));
