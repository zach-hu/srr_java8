...
public class PostResponse  implements java.io.Serializable {
    ...
    /* The document number you may
     *                             have supplied (applies to Batch Load). */
     ...
     * 
     * @return suppliedNumber   * The document number you may
     *                             have supplied (applies to Batch Load).
     */
     ...
     * 
     * @param suppliedNumber   * The document number you may
     *                             have supplied (applies to Batch Load).
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/input/input-11.2/webservice", ">PostResponse"));
