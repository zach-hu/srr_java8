...
public class GetMissingDocNumbersResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    /* The code of the
     *                                 country in which you attempted to
     * search
    ...
    /* The code of the
     *                                 document master you attempted to search
     * for missing document
     *                             numbers. */
    private java.lang.String docCode;

    /* The missing document
     *                                 number you attempted to search
     *                             for. */
    private java.lang.String docNum;

    /* The year/period you
     *                                 attempted to search for missing document
     * numbers. */
    private java.lang.String period;

    /* The reason why the
     *                                 document number was not
     *                             used. */
    private java.lang.String description;

    /* Contains the missing
     *                                 document numbers retrieved by the
     *                             GetMissingDocNumbersRequest. */
     ...
     *
     * @return docNum   * The missing document
     *                                 number you attempted to search
     *                             for.
     */
     ...
     *
     * @param docNum   * The missing document
     *                                 number you attempted to search
     *                             for.
     */
     ...
     *
     * @return period   * The year/period you
     *                                 attempted to search for missing document
     * numbers.
     */
     ...
     *
     * @param period   * The year/period you
     *                                 attempted to search for missing document
     * numbers.
     */
     ...
     *
     * @return description   * The reason why the
     *                                 document number was not
     *                             used.
     */
     ...
     *
     * @param description   * The reason why the
     *                                 document number was not
     *                             used.
     */
     ...
     *
     * @return missingDocNumbers   * Contains the missing
     *                                 document numbers retrieved by the
     *                             GetMissingDocNumbersRequest.
     */
     ...
     *
     * @param missingDocNumbers   * Contains the missing
     *                                 document numbers retrieved by the
     *                             GetMissingDocNumbersRequest.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "GetMissingDocNumbersResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "Description"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "MissingDocNumbers"));
