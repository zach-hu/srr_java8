...
public class PostToXResponse  extends com.coda.www.efinance.schemas.input.PostToXResponse  implements java.io.Serializable {
    /* Contains details of
    ...
    /**
     * Gets the problems value for this PostToXResponse.
     * 
    ...
    /**
     * Sets the problems value for this PostToXResponse.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "PostToXResponse"));
