...
public class SetHeaderResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
    /* Contains the
     *                                 transaction details, with the new
     * header
     *                             information. */
    ...
    /* The SelectedValue
     *                                 supplied in the request corresponding
     * to
     *                                 this response. */
     ...
     *
     * @return numberOfDecimals   * The number of decimal
     *                                 places in the document
     *                             currency.
     */
     ...
     *
     * @param numberOfDecimals   * The number of decimal
     *                                 places in the document
     *                             currency.
     */
     ...
     *
     * @return selectedValue   * The SelectedValue
     *                                 supplied in the request corresponding
     * to
     *                                 this response.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "SetHeaderResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "NumberOfDecimals"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext", "SelectedValue"));
