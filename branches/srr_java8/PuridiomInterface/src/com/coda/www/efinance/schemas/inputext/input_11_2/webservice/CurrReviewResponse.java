...
public class CurrReviewResponse  implements java.io.Serializable {
    /* Contains results information
     *                             for the CurrReview request corresponding
     * to
     *                             this response. */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext/input-11.2/webservice", ">CurrReviewResponse"));
