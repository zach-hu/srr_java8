...
public class GetCopyDocParamsResponse  implements java.io.Serializable {
    /* Contains a key uniquely
     *                             identifying the new document. */
    private com.coda.www.efinance.schemas.transaction.TxnKey key;

    /* The document date of the new document. */
     ...
     * 
     * @return newDate   * The document date of the new document.
     */
     ...
     * 
     * @param newDate   * The document date of the new document.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext/input-11.2/webservice", ">GetCopyDocParamsResponse"));
