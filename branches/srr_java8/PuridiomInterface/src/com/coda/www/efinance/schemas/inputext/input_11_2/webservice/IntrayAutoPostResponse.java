...
public class IntrayAutoPostResponse  implements java.io.Serializable {
    /* Contains results information
     *                             for the documents posted by the
     *                             IntrayAutoPost request corresponding to
     * this response. */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext/input-11.2/webservice", ">IntrayAutoPostResponse"));
