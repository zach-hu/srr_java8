...
public class PostToBooksResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the problems value for this PostToBooksResponse.
     * 
    ...
    /**
     * Sets the problems value for this PostToBooksResponse.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputext/input-11.2/webservice", ">PostToBooksResponse"));
