...
public class GetResponse  extends com.coda.www.efinance.schemas.common.Response  implements java.io.Serializable {
     ...
     *                                 retrieve an input template
     *                             master. */
    private java.lang.String cmpCode;

    /* The code for the
     *                                 input template master that you attempted
     * to retrieve. */
    private java.lang.String code;

    /* Contains a input
     *                                 template master you have retrieved
     * from
     *                                 the database. */
     ...
     *
     * @return inputTemplate   * Contains a input
     *                                 template master you have retrieved
     * from
     *                                 the database.
     */
     ...
     *
     * @param inputTemplate   * Contains a input
     *                                 template master you have retrieved
     * from
     *                                 the database.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputtemplate", "GetResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/inputtemplate", "InputTemplate"));
