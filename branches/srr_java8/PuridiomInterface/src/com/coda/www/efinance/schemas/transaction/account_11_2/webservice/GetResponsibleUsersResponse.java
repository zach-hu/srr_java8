...
public class GetResponsibleUsersResponse  implements java.io.Serializable {
    /* A company code. */
    ...
    /* A list of responsible user codes. */
     ...
     * 
     * @return responsibleUsers   * A list of responsible user codes.
     */
     ...
     * 
     * @param responsibleUsers   * A list of responsible user codes.
     */
     ...
     * 
     * @return firstFailedAccount   * The details of the first
     *                             failed account.
     */
     ...
     * 
     * @param firstFailedAccount   * The details of the first
     *                             failed account.
     */
     ...
     * 
     * @return overLimit   * Indicates whether the values
     *                             exceeds the specified limit.
     */
     ...
     * 
     * @param overLimit   * Indicates whether the values
     *                             exceeds the specified limit.
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction/account-11.2/webservice", ">GetResponsibleUsersResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction/account-11.2/webservice", "ResponsibleUsers"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/common", "typeGeneralCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction", "UserCode"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction/account-11.2/webservice", "FirstFailedAccount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction", "DestAndAccount"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://www.coda.com/efinance/schemas/transaction/account-11.2/webservice", "OverLimit"));
