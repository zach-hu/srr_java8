...
public class DisbLineExtendedCreateCheck extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			incomingRequest.put("DocComment_icHeader", reqLine.getIcReqHeader().toString());
			incomingRequest.put("DocComment_icLine", reqLine.getIcReqLine().toString());
