...
public class InvAlternateRetrieveAllTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InvAlternateRetrieveAll test = new InvAlternateRetrieveAll();
			...
			System.out.println("InvAlternateRetrieveAllTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
