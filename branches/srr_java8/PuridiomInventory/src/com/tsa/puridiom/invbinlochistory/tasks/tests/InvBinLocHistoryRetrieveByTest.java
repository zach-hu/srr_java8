...
public class InvBinLocHistoryRetrieveByTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InvBinLocHistoryRetrieveBy test = new InvBinLocHistoryRetrieveBy();
			...
			System.out.println("InvBinLocHistoryRetrieveByTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
