...
public class InventoryReceiptGetHistory extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            ReceiptLine newReceiptLine	= (ReceiptLine) incomingRequest.get("newReceiptLine");
            InvBinLocation newInvBinLocation	= (InvBinLocation) incomingRequest.get("newInvBinLocation");
            ...
            InventoryReceiptSetupValues historyBuild = new InventoryReceiptSetupValues();
            ...
            history = historyBuild.getHeaderHistoryLog(newInvBinLocation,  newReceiptLine);
