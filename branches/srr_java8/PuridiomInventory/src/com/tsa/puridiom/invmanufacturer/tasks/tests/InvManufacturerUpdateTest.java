...
public class InvManufacturerUpdateTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InvManufacturerUpdate test = new InvManufacturerUpdate();
			...
			if (dbs.getStatus() == Status.SUCCEEDED) {
				System.out.println("InvManufacturerUpdateTest SUCCESS");
				dbs.commit();
			}
		
			System.out.println(incomingRequest);
			System.out.println("InvManufacturerUpdateTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
