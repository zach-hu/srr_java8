 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class UpdateDsbLineStatus extends Task
{
    ...
    public Object executeTask(Object object) throws Exception
    {
        try
        {
            ...
            BigDecimal icDsbLine = invReturn.getIcDsbLine();
            String updateSql = "UPDATE disb_line SET status = ? WHERE ic_dsb_line = ?";
            Object [] args = {status, icDsbLine.toString()};
