...
public class InvoiceApprovalAddApprover extends Task
{
	...
	public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            if (appRuleUser.isRegistered() && appRuleUser.isVchApprover() && appRuleUser.getStatus().equals("02"))
            {
