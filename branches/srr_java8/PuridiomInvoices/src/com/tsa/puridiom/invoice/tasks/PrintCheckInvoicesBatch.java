...
public class PrintCheckInvoicesBatch extends Task
{
	public Object executeTask(Object object) throws Exception {
        ...
        try
        {
            ...
            /*for (Iterator it = checkList.iterator(); it.hasNext(); )
		    {
        		...
        		pdfParameters.add( this.getInvoicePdfs(invoiceCheck, organizationId));

		    }*/

            PuridiomProcessLoader processLoader = new PuridiomProcessLoader();
            PuridiomProcess process = processLoader.loadProcess("check-batch-pdf.xml");
	...
	public Object getInvoicePdfs(InvoiceCheck invoiceCheck, String organizationId) throws Exception
	{
		Object ret = null;
		PuridiomProcessLoader processLoader = new PuridiomProcessLoader();
        PuridiomProcess process = processLoader.loadProcess("check-batch-pdf.xml");
        ...
        incomingRequest.put("invoiceCheck", invoiceCheck);
        incomingRequest.put("webreport", "R");
        incomingRequest.put("organizationId", organizationId);
        process.executeProcess(incomingRequest);
