...
public class GenerateInvoiceExtractTemplate extends Task
{
	public Object  executeTask (Object object) throws Exception {
		...
		try {
			...
			try {
				...
				String filename = path + "invoice-extract.xml";
				...
				try {
				    String	delimiter = xmlFile.getRootChild("delimiter").getText();

				    if (delimiter == null) delimiter = "" ;
				    extractTemplate.setDelimiter(delimiter) ;
				}
				catch (Exception e) {
				    extractTemplate.setAccountRollup(false);
				}
