...
import com.tsa.puridiom.sungard.extract.tasks.SungardInvoiceExtractByAccountSetup;
import com.tsagate.foundation.utility.Dates;
import java.math.BigDecimal;
import java.util.*;

public class SungardInvoiceExtractByAccountSetupTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			SungardInvoiceExtractByAccountSetup task = new SungardInvoiceExtractByAccountSetup();
			...
			List defaultAccountList = new ArrayList();
			List accountList1 = new ArrayList();
			List accountList2 = new ArrayList();
			List accountList3 = new ArrayList();

			defaultAccountList.add(account1);
			defaultAccountList.add(account2);

			accountList1.add(account3);
			accountList1.add(account4);
			accountList2.add(account5);
			accountList3.add(account6);
			accountList3.add(account7);
			accountList3.add(account8);

			InvoiceHeader invoiceHeader = new InvoiceHeader();
			invoiceHeader.setAccountList(defaultAccountList);

			InvoiceLine invoiceLine1 = new InvoiceLine();
			invoiceLine1.setAccountList(accountList1);
			invoiceLine1.setLineTotal(new BigDecimal("50.00"));

			InvoiceLine invoiceLine2 = new InvoiceLine();
			invoiceLine2.setAccountList(accountList2);
			invoiceLine2.setLineTotal(new BigDecimal("30.00"));

			InvoiceLine invoiceLine3 = new InvoiceLine();
			invoiceLine3.setAccountList(accountList3);
			invoiceLine3.setLineTotal(new BigDecimal("100.00"));

			InvoiceLine invoiceLine4 = new InvoiceLine();
			invoiceLine4.setLineTotal(new BigDecimal("75.00"));

			InvoiceLine invoiceLine5 = new InvoiceLine();
			invoiceLine5.setLineTotal(new BigDecimal("125.00"));

			List invoiceLineList = new ArrayList();
			invoiceLineList.add(invoiceLine1);
			invoiceLineList.add(invoiceLine2);
			invoiceLineList.add(invoiceLine3);
			invoiceLineList.add(invoiceLine4);
			invoiceLineList.add(invoiceLine5);
