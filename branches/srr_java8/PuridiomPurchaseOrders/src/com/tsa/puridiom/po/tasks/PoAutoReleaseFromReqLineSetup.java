 ...
 */
public class PoAutoReleaseFromReqLineSetup extends Task
{
    ...
    public Object executeTask(Object object) throws Exception
    {
        try
        {
            ...
            newPoHeader.setShipToCode((String)incomingRequest.get("shipToCode"));
            newPoHeader.setRequisitionerCode("");
            /*
             *
