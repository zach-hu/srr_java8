...
public class PoHeaderRetrieveCurrencyCode extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "select PoHeader.currencyCode from PoHeader as PoHeader where PoHeader.icPoHeader = ? ";
