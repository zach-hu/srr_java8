...
public class PoHeaderRetrieveSupercededBy extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			if( incomingRequest.get("poHeader") != null )
			{
				...
				if ( !HiltonUtility.isEmpty(poHeader.getLinkNextOrder()) )
				{
					String displayPoNumber = poHeader.getLinkNextOrder();
					...
					if (result != null)
					{
						BigDecimal linkNextOrder_icPoHeader = (BigDecimal) result;
						incomingRequest.put("linkNextOrder_icPoHeader", linkNextOrder_icPoHeader);
					}
				}
			}
