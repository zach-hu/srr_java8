 ...
 */
public class PoLineRetrieveByLineNumber extends Task {
	/* (non-Javadoc)
	...
	public Object executeTask(Object object) throws Exception {
        ...
        //String lineNumber = (String)incomingRequest.get("PoLine_lineNumber") ;
        ...
        String queryString =  	"select b from PoLine as b where b.icPoHeader = ? AND b.lineNumber = ?" ;
