...
public class PoLineUpdateRfqLinesStatus extends Task
{
            ...
            if (incomingRequest.containsKey("poLine"))
            {
                ...
                if (poLine != null)
                {
                    ...
                    if (icRfqLine != null && icRfqLine.compareTo(new BigDecimal(0)) > 0)
                    {
                        ...
                        requestParameters.put("RfqLine_icPoLine", poLine.getIcPoLine().toString());
                        ...
                        if(poHeader != null)
                        {
                        	requestParameters.put("RequisitionLine_blanketOrder", poHeader.getDisplayPoNumber(false));
                        }

                        Log.debug(this, "Updating Rfq Status from Po " + poLine.getPoNumber() + " line status " + status);
