 ...
 * @author Richard
 */
public class PromisedDateFromCatalogItem extends Task {
	/* (non-Javadoc)
	...
	public Object executeTask(Object object) throws Exception {
		...
		try {
		    ...
		    if(incomingRequest.containsKey("PoLine_catalogId") && incomingRequest.containsKey("PoLine_itemNumber")){
		    	...
		    	String poPromised = (String) incomingRequest.get("PoLine_poPromised");
		    	if(!HiltonUtility.isEmpty(catalogId) && !HiltonUtility.isEmpty(itemNumber) && HiltonUtility.isEmpty(poPromised) )
		    	{
