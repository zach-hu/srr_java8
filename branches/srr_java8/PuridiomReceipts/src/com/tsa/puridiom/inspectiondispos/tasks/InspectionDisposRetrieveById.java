...
public class InspectionDisposRetrieveById extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "from InspectionDispos as InspectionDispos where InspectionDispos.id.icRecHeader = ? and InspectionDispos.id.icRecLine = ? and InspectionDispos.id.keySequence = ? ";
