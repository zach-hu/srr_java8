...
public class InspectionDisposRetrieveAllTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InspectionDisposRetrieveAll test = new InspectionDisposRetrieveAll();
			...
			System.out.println("InspectionDisposRetrieveAllTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
