...
public class InspectionDisposUpdateTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InspectionDisposUpdate test = new InspectionDisposUpdate();
			...
			if (dbs.getStatus() == Status.SUCCEEDED) {
				System.out.println("InspectionDisposUpdateTest SUCCESS");
				dbs.commit();
			}
		
			System.out.println(incomingRequest);
			System.out.println("InspectionDisposUpdateTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
