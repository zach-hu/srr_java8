...
public class InspectionHeaderListRetrieveByIcMsrLine extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			if (icMsrLineString == null) icMsrLineString = (String) incomingRequest.get("ReceiptLine_icLineHistory");
			if (icMsrLineString == null) icMsrLineString = "0" ;
			BigDecimal icMsrLine = new BigDecimal ( icMsrLineString );

			String queryString = "from InspectionHeader as InspectionHeader where  InspectionHeader.id.icMsrLine = ? ";
