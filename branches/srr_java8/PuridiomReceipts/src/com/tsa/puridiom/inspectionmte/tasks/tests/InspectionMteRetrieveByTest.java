...
public class InspectionMteRetrieveByTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			InspectionMteRetrieveBy test = new InspectionMteRetrieveBy();
			...
			System.out.println("InspectionMteRetrieveByTest COMPLETE");
		}
		catch (Exception e)
		{
			e.printStackTrace();
