...
public class ReceiptReflectStatus extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
        	...
        	String  reflectStatus = propertiesManager.getProperty("REC OPTIONS","REFLECTSTATUS","N");
        	
//        	if(reflectStatus.equalsIgnoreCase("Y") && receiptHeader.getReceiptStatus().compareToIgnoreCase(DocumentStatus.RCV_RECEIVED) == 0)
        	if(reflectStatus.equalsIgnoreCase("Y"))
        	{
        		...
        		reviewIncomingRequest.put("receiptHeader", receiptHeader);
    			...
    			PuridiomProcess process = processLoader.loadProcess("rec-update-status.xml");
