 ...
 *
 */
package com.tsa.puridiom.formtext.tasks;
...
//			content.append("---------------------------------\r\n");
			...
			idApprovalLink = this.getURLAction(userId, organizationId, reqHeader.getRequisitionNumber(), reqHeader.getIcReqHeader());

			content.append("<br>");
			content.append("To APPROVE, click below: \r\n");
			content.append(siteUrl + "/ApproveR/" + idApprovalLink + "\r\n");
			content.append("or reply to this email with APPROVE \r\n");
			content.append("on the first line. \r\n");
			content.append("<br>");
			content.append("To REJECT, click below: \r\n");
			content.append(siteUrl + "/RejectR/" + idApprovalLink + "\r\n");
			content.append("or reply to this email with REJECT \r\n");
			content.append("on the first line followed by your \r\n");
			content.append("rejection note. \r\n");
	...
	public String getURLAction(String userId, String organizationId, String requisitionNumber, BigDecimal icReqHeader) throws Exception
	{
		...
		incomingRequest.put("ApprovalLink_documentNumber", requisitionNumber);
		incomingRequest.put("ApprovalLink_icHeader", icReqHeader.toString());
		incomingRequest.put("ApprovalLink_doctype", "REQ");

		process.executeProcess(incomingRequest);

		approvalLink = (ApprovalLink) incomingRequest.get("approvalLink");

		return (approvalLink.getIcApprovalLink().toString() + organizationId);
	}
