 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class RequisitionLineReportHtml extends Task
{
    ...
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
	       ...
	       // filePath = path + "requisition-line.jasper";
	        ...
	        filePath =  DictionaryManager.getInstance("host", organizationId).getProperty("reportsOut", "") + nameIt + ".html";
	        //JasperManager.printReportToPdfFile(jasperPrint, filePath);
	        //JasperPrintManager.printReport(filePath, true);
	        //JasperExportManager.exportReportToHtmlFile(filePath);
