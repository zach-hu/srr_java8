...
public class EmailLetterPdf
{
    ...
    {
    	return this.createMe(icRfqHeader, TCs);
    }

    public Object createMe(String icRfqHeader, String TCs, String vendor, String type)
    {
        ...
        try
        {
            ...
            PuridiomProcess process = processLoader.loadProcess("print-rfq-letter.xml");
            ...
            incomingRequest.put("PdfRfq_vendorId", vendor);
            incomingRequest.put("letter", type);
                	...
                	if(attchList.size() > 0)
                	{
	                	...
	                	for(int i = 0; i < attchList.size(); i++)
	                	{
	                		...
	                		if(attachment.getDocPrint().equalsIgnoreCase("Y"))
	                		{
		                		...
		                		String tmp = this.getAttachmentName(attachment);
            ...
            RfqSupplierEmailUtility rfqSupplierEmailUtility = new RfqSupplierEmailUtility();

            this.emailTo = rfqSupplierEmailUtility.getToEmail(incomingRequest);
        }
    ...
    {
    	Log.debug(this, "PDF, " + "getAttachmentName");
