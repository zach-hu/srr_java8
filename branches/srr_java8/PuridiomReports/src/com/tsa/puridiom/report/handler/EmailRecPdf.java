...
public class EmailRecPdf
{
    ...
    {
    	Log.debug(this, "REC PDF, " + "createMessage: ic:" + icPoHeader );
        String reportName = "";
        Object ret = null;
        try
        {
            PuridiomProcessLoader processLoader = new PuridiomProcessLoader();
            PuridiomProcess process = processLoader.loadProcess("print-recpdf.xml");
            Map incomingRequest = new HashMap();
            incomingRequest.put("ReceiptHeader_icRecHeader", icPoHeader);
            ...
            if (process.getStatus() == Status.SUCCEEDED)
            {
                ...
                Log.debug(this, "REC PDF, " + "createMessage reportName:" + this.getReportName());
            ...
            List attchList = receiptHeader.getDocAttachmentList();
            if(attchList != null)
            {
            	if(attchList.size() > 0)
            	{
    ...
    {
    	Log.debug(this, "REC PDF, " + "getAttachmentName");
