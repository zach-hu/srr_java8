...
public class EmailReqHtml
{
    ...
    public String createMe(String icHeader)
    {
        String reportName = "";
        try
        {
            PuridiomProcessLoader processLoader = new PuridiomProcessLoader();
            PuridiomProcess process = processLoader.loadProcess("req-email-approvals.xml");
    ...
    public static void main(String[] args)
    {
        ...
        EmailReqHtml pdf = new EmailReqHtml();
        System.out.println(pdf.createMe("1690130100026"));
