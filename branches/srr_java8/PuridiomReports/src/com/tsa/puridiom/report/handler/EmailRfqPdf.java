...
public class EmailRfqPdf
{
    ...
    public Object createMe(String icRfqHeader, String TCs, String vendor)
    {
        ...
        try
        {
            ...
            PuridiomProcess process = processLoader.loadProcess("emailrfqpdf.xml");
