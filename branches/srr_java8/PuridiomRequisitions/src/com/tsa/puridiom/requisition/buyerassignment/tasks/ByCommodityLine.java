 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class ByCommodityLine extends Task
{
    ...
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            Log.debug(this, "Assign By Commodity");
            ...
            for(int i = 0; i < lines.size(); i++)
            {
                ...
                if(!rql.getAssigned())
                {
	                ...
	                {
	                    lineBuyer = HiltonUtility.ckNull(this.byCommodity(rql, incomingRequest));
	                }
    ...
    private String byCommodity(RequisitionLine rql, Map incomingRequest)
    {
        ...
        if(!Utility.isEmpty(commodityCode))
        {
            ...
            try
            {
                ...
                {
                    sBuyer = HiltonUtility.ckNull(commodity.getBuyerCode());
                }
            }
            catch (Exception e)
            {
