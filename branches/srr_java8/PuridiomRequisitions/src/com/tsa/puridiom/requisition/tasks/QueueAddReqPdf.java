...
public class QueueAddReqPdf extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            {
                subject.append("Requisition " + (String)incomingRequest.get("RequisitionHeader_requisitionNumber")) ;
            }
    ...
    public String getToEmail(Map incomingRequest)
    {
        ...
        if(Utility.isEmpty(email))
        {
        	Log.warn(this, "No email was specified for request: " + incomingRequest.get("RequisitionHeader_requisitionNumber"));
            email = "";
        }
