...
public class RequisitionHeaderRetrieveTotal extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "select RequisitionHeader.total from RequisitionHeader as RequisitionHeader where RequisitionHeader.icReqHeader = ? ";
