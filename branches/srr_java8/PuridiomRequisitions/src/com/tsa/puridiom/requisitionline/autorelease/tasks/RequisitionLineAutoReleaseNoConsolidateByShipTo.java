 ...
 */
public class RequisitionLineAutoReleaseNoConsolidateByShipTo extends Task
{
            ...
            {//items to create release for
                ...
                for (Iterator iter = keys.iterator(); iter.hasNext();)
                {
                    ...
                    if(blanket != null)
                    {
	                    ...
	                    List reqNumberkeys = new ArrayList(groupByReq.keySet());

	                    Collections.sort(reqNumberkeys);
                    	...
                    	for (Iterator iterShipTos = reqNumberkeys.iterator(); iterShipTos.hasNext();)
	                    {
	                        ...
	                        if (rlao.getShipTo() != null) {
	                        	newIncomingRequest.put("autoShipToHeader", rlao.getShipTo());
	                        }

	                        PuridiomProcessLoader processLoader = new PuridiomProcessLoader();

	                        PuridiomProcess process = processLoader.loadProcess("po-create-release-partial-by-shipto.xml");
