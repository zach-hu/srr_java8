...
public class RequisitionLineCommentUpdateTest
{
	public static void  main (String[] args) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("requisitionline-comment-update.xml");
