	...
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
		    ...
		    if (!Utility.isEmpty(mailId)) {
				...
				String servlet = "/ResetSupplierPasswordRedirectServlet" ;
				...
				if (resetPasswordLink == null) {
					...
					link = siteUrl + servlet + "/ack=x100&oid=" + oid + "&userId="+ mailId  + "&edoc=" + resetPasswordLink.getIcLink();
				}
			    ...
			    */
			    ...
			    message += "\n\n" + "A request was received to retrieve the password for your Puridiom 4.0 Supplier Portal Login ID.";
