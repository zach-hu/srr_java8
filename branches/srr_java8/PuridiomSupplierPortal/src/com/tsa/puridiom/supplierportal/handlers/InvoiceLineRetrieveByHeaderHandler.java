...
public class InvoiceLineRetrieveByHeaderHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("invoiceline-retrieve-by-header.xml");
