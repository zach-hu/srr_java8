...
public class RfqBidHistoryUnitPriceListRetrieveByLineVendorHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("rfqbidhistory-unitpricelist-retrieve-by-line-vendor.xml");
