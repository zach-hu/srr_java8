...
public class SupplierCertsChecklistUpdateByHeaderHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("suppliercerts-checklist-update-by-header.xml");
