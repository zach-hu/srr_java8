...
public class PasswordValidation extends Task {
	...
	public Object executeTask(Object object) throws Exception {
		...
		try {
			...
			if (Utility.isEmpty(organizationId)) {
			    organizationId = (String) incomingRequest.get("VendorRegister_organizationId");
			}
			...
			bidboardUser.setUserPassword(BlackBox.getEncrypt(password));
