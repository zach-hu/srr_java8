	...
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
		    ...
		    if (registerUser != null && !Utility.isEmpty(registerUser.getEmailAddress())) {
			    ...
			    String message = "\n\nUse the above link to help log in and create a permanent password for your account at " + PropertiesManager.getInstance(organizationId).getProperty("VENDOR-REGISTRATION", "URL", "http://my.puridiom.com/vendor-registration");
