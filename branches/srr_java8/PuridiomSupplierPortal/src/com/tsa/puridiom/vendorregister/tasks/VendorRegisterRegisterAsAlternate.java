...
public class VendorRegisterRegisterAsAlternate extends Task
{
	public Object executeTask(Object object) throws Exception
	{
		...
		try
		{
			...
			//system.out.println("REGISTER AS ALTERNATE...");
			//system.out.println("Vendor Id - " + registerUser.getVendorId());
			...
			vendorRegister.setContactType("ALTERNATE");
