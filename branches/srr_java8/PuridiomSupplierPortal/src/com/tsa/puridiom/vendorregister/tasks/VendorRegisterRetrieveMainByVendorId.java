...
public class VendorRegisterRetrieveMainByVendorId extends Task{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			List resultList = dbs.query(queryString, new Object[] {vendorId, "MAIN", } , new Type[] { Hibernate.STRING, Hibernate.STRING}) ;
