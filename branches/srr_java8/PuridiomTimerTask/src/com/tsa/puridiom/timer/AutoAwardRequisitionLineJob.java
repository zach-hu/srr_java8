...
public class AutoAwardRequisitionLineJob extends ScheduledJob
{
	...
	public void getReqLinesToExecute()
	{
		...
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("requisitionheader-retrieve-for-autoawardrequisitionbyline.xml");
