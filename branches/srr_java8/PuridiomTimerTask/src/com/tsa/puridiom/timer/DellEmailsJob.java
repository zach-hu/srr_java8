 ...
 * @author Johnny
 */
public class DellEmailsJob extends ReadInboxJob
{

	public void onStart()
	{
		this.setJobType("dellemail");
	}
	...
	public int processEmail(File emailFile, String subject, String sendFrom, String organizationId)
	{
		...
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("dell-email-process.xml");
			...
			incomingRequest.put("actionType", EmailActionCodes.HTMLEMAIL);
