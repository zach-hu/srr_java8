...
public class UserActivationJob extends ScheduledJobAction
{

	public void execute()
	{
		this.activateAuthenticatedUsers();
		Log.debug(this, "UserActivationJob done");
	}

	protected void activateAuthenticatedUsers()
	{
		try
		{
