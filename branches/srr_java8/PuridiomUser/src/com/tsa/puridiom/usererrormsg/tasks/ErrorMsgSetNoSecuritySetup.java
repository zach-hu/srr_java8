...
public class ErrorMsgSetNoSecuritySetup extends Task
{
	public Object  executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			message = message + "  You must contact your system administrator or support@puridiom.com to reset your password.";
