...
public class UserProfileRetrieveRecInspection extends Task
{
	public Object executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String queryString = "select UserProfile.userId, count(ReceiptHeader.icRecHeader) " +
				...
				"and ReceiptHeader.icRecHeader in (Select distinct ReceiptLine.icRecHeader from ReceiptLine as ReceiptLine " +
				"where ReceiptLine.status = ? and ReceiptLine.inspectorAssigned = UserProfile.userId) " +
			...
			incomingRequest.put("UserPreference_property", "RECININSPECTIONCNT");
			result = resultList;
