...
public class UserProfileUpdateRecDelivery extends Task
{
	public Object executeTask (Object object) throws Exception
	{
		...
		try
		{
			...
			String recStatus = DocumentStatus.RCV_STEP_3;
			String property = "RECINDELIVERYCNT";
			...
			String sqlString = "UPDATE User_Preference SET VALUE = (select count(ReceiptHeader.ic_Rec_Header) " +
				...
				"and ReceiptHeader.ic_Rec_Header in (Select distinct ReceiptLine.ic_Rec_Header from Receipt_Line as ReceiptLine where ReceiptLine.status = ?) " +
