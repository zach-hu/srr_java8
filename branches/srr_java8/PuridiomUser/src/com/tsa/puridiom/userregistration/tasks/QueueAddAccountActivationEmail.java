...
public class QueueAddAccountActivationEmail extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            Log.debug(this, "Writting send_queue record for account activation of User ID: " + userId + ", Organization ID " + organizationId);


            StringBuffer subject = new StringBuffer("Your new Puridiom 4.0 Hosted account has been set up!");
