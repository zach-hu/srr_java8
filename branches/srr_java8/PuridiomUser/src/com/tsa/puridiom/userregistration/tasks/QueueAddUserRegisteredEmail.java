...
public class QueueAddUserRegisteredEmail extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
        	...
        	String administrator = UserManager.getInstance().getAdministratorName(organizationId);
            ...
            Log.debug(this, "Writting send_queue record for user registration of User ID: " + userId + ", Organization ID " + organizationId);


            StringBuffer subject = new StringBuffer("Your new Puridiom 4.0 login account has been set up by " + administrator + "!");
            ...
            incomingRequest.put("SendQueue_doctype", "USR");
        ...
        {
           this.setStatus(Status.FAILED);
            throw new TsaException("Error processing HTML email for registration.");
        }
        return result;
    }
}