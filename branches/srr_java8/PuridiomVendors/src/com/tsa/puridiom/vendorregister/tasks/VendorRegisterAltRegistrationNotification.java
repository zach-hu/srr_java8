...
public class VendorRegisterAltRegistrationNotification extends Task
{
    public Object executeTask(Object object) throws Exception
    {
        ...
        try
        {
            ...
            incomingRequest.put("SendQueue_messagetext", vendorRegister.getContactDisplayName() + " [" + vendorRegister.getComp_id().getContactEmailAddr() + "] has registered as an alternate contact for the registered vendor: " + vendorRegister.getVendorName() + " [" + vendorRegister.getComp_id().getVendorId() + "] on " + HiltonUtility.getFormattedDate(vendorRegister.getDateEntered(), organizationId) +".");
