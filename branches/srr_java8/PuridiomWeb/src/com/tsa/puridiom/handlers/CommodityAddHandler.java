...
public class CommodityAddHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("commodity-add.xml");
			...
			if (process.getStatus() == Status.SUCCEEDED)
			{
				...
				else
				{
				     ...
				     *  so that after a commodity record is successfully added
				     *  the user gets returned back to the commodity browse
