...
public class StdTableAddHandler implements IHandler
{
	public Map  handleRequest (Map incomingRequest) throws Exception
	{
		try
		{
			...
			PuridiomProcess process = processLoader.loadProcess("stdtable-add.xml");
			...
			if (process.getStatus() == Status.SUCCEEDED)
			{
				...
				else
				{
				    ...
				    /*
				     *  kathleen added the following on 06-08-05
				     *  so that after a stdtable record is successfully added
				     *  the user gets returned back to the stdtable browse
				     */
