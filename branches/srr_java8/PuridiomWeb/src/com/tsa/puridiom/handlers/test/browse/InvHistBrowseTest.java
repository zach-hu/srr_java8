...
public class InvHistBrowseTest
{
	public static void  main (String[] args) throws Exception
	{
		...
		try 
		{
			...
			incomingRequest.put("browseName", "inv-pohist");
			incomingRequest.put("colname", "poLine_itemNumber");
			incomingRequest.put("operator", "=");
			incomingRequest.put("filter_txt", "1000");
