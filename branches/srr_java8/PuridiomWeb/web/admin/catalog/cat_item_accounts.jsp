...
<%
	...
	String	s_ic_account = HiltonUtility.ckNull((String) request.getAttribute("CatalogItem_icAccount"));
	...
	{
		String location = "ACCOUNT_" + user.getLocale();
...
<tr>
	<td valign=top>
		...
		<tr>
		  ...
		  <TD <%=HtmlWriter.isVisible(oid, "allocationMethod")%> WIDTH="75px" ALIGN="CENTER"><INPUT TYPE="radio" value="AL" NAME="alloc_method" <% if (s_alloc_method.equals("AL")) { %>CHECKED<%}%> ONCLICK="setMethod();" VALIGN="MIDDLE"> <%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "smount", "Amount")%></TD>
...
<tr>
	...
	<% if (roleR.getAccessRights("CATITEM") >= 3) { %>
		<div id="pxbutton"><a href="javascript: doSubmit('/admin/catalog/catalog_item.jsp', 'ItemAccountUpdate;CatalogItemRetrieveById'); void(0);">Save</a></div>
	<% } %>
	</td>
...
<!-- Hide script
	...
	//setNavCookie("/admin/catalog/cat_item_accounts.jsp", "AccountRetrieveByLine", "Accounts");
	hideArea("navTable");
