	...
	<td valign=top width=135px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 vAlign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12><span class="hdr12" style="margin-left:10px; margin-right:10px"><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "pre-qualificationInformation", "Pre-Qualification Information")%></span></div>			</td>
			<td nowrap class=hdr12 vAlign=middle>
				<a href="javascript: viewDocs(); void(0);"><img name="img_attach" src="<%=contextPath%>/images/clip.gif" border=0 valign=top alt="Click here to upload documents"></a>&nbsp;			</td>
		</tr>
		</table>
	</td>
...
<%	}%>
		...
		<tr <%=HtmlWriter.isVisible(oid, "bb-dunsNumber")%>>
			...
			<td><i>**  <%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "canLookNumberAt", "")%> <b><a  href="http://www.dnb.com/" id="A1" tabindex=-1 target="_blank">http://www.dnb.com/</a>&nbsp; **</i></td>
		</tr>
		...
		<tr <%=HtmlWriter.isVisible(oid, "bb-sup-urlAddress")%>>
			<td align=right nowrap><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-sup-urlAddress", "Web Address", true)%></td>
...
<tr <%=HtmlWriter.isVisible(oid, "bb-sup-remitto")%>>
	<td width=5px>&nbsp;</td>
	<td width=125px valign=top><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "remitTo", "Remit To Address")%></b></td>
	<td width=5px>&nbsp;</td>
	<td width=2px class=darkShadow><img src="<%=contextPath%>/images/none.gif" order=0 width=2px height=100% class=darkShadow></td>
	<td width=5px>&nbsp;</td>
	<td>
		...
		<tr <%=HtmlWriter.isVisible(oid, "bb-rt-paymentType")%>>
			<td align=right nowrap><%=DictionaryManager.getLabel(oid, "bb-rt-paymentType", "Payment Type", true)%></td>
		...
		<tr <%=HtmlWriter.isVisible(oid, "bb-accountType")%>>
			...
			<td colspan=2>
				<select name="VendorRegister_eftAccountType">
					<option value="E" <% if ((vendorRegister.getEftAccountType()).equals("E")){%> SELECTED <%}%>>ETF</option>
				...
				<tr>
					<td <%=HtmlWriter.isVisible(oid, "bb-cnt-salutation")%>>
						<select name="VendorRegister_altSalutation">
							...
							<option value="Ms." <% if (vendorRegister.getAltSalutation().equals("Ms.")) {%>selected<%}%>><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "ms", "Ms")%>.</option>
...
<tr>
	<td>&nbsp;</td>
	<td valign=top><br><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-additionalInformation", "Additional Information")%></b></td>
	<td>&nbsp;</td>
...
<%
	...
	if (vendorUdf1List != null && vendorUdf1List.size() > 0) { %>
		...
		<tr>
			<td nowrap ><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN01", "Supplier UDF 01", true)%> / <%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "checkAllApply", "Check all that apply")%></b></td>
		</tr>
		<tr>
			<td>
				<table border=0 width=100% cellpadding=0 cellspacing=0 align=center>
...
<%	} else {%>
		...
		<tr>
			<td align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN01", "Supplier UDF 01", true)%></td>
...
<%	}
	...
	if (vendorUdf2List != null && vendorUdf2List.size() > 0) { %>
		...
		<tr>
			<td nowrap ><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN02", "Supplier UDF 02", true)%> / <%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "checkAllApply", "Check all that apply")%></b></td>
		</tr>
		<tr>
			<td>
				<table border=0 width=100% cellpadding=0 cellspacing=0 align=center>
...
<%	} else {%>
		...
		<tr>
			<td align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN02", "Supplier UDF 02", true)%></td>
...
<%	}
		...
		<tr>
			<td nowrap ><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN03", "Supplier UDF 03", true)%> / <%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "checkAllApply", "Check all that apply")%></b></td>
		</tr>
		<tr>
			<td>
				<table border=0 width=100% cellpadding=0 cellspacing=0 align=center>
...
<%		} else {%>
		...
		<tr>
			<td align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN03", "Supplier UDF 03", true)%></td>
...
<%		}
	...
	if (vendorUdf4List != null && vendorUdf4List.size() > 0) { %>
		...
		<tr>
			<td nowrap ><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN04", "Supplier UDF 04", true)%> / <%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "checkAllApply", "Check all that apply")%></b></td>
		</tr>
		<tr>
			<td>
				<table border=0 width=100% cellpadding=0 cellspacing=0 align=center>
...
<%	} else {%>
		...
		<tr>
			<td align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN04", "Supplier UDF 04", true)%></td>
...
<%	}
	...
	if (vendorUdf5List != null && vendorUdf5List.size() > 0) { %>
		...
		<tr>
			<td nowrap ><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN05", "Supplier UDF 05", true)%> / <%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "checkAllApply", "Check all that apply")%></b></td>
		</tr>
		<tr>
			<td>
				<table border=0 width=100% cellpadding=0 cellspacing=0 align=center>
...
<%	} else {%>
		...
		<tr>
			<td align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN05", "Supplier UDF 05", true)%></td>
...
<%	}%>
		...
		<tr>
			<td <%=HtmlWriter.isVisible(oid, "bb-VN06")%> align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN06", "Supplier UDF 06", true)%></td>
			...
			<td <%=HtmlWriter.isVisible(oid, "bb-VN07")%> align=right nowrap><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN07", "Supplier UDF 07", true)%></td>
		...
		<tr>
			<td <%=HtmlWriter.isVisible(oid, "bb-VN08")%> align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN08", "Supplier UDF 08", true)%></td>
			...
			<td <%=HtmlWriter.isVisible(oid, "bb-VN09")%> align=right nowrap><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN09", "Supplier UDF 09", true)%></td>
		...
		<tr>
			<td <%=HtmlWriter.isVisible(oid, "bb-VN10")%> align=right nowrap width=150px><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bb-VN10", "Supplier UDF 10", true)%></td>
			<td <%=HtmlWriter.isVisible(oid, "bb-VN10")%>><input name="VendorRegister_vendorUdf8" value="<%=vendorRegister.getVendorUdf10()%>" maxLength=15></td>
		</tr>
		</table>
		<br>
		<table border=0 cellspacing=1 cellpadding=1 width=100%>
...
<tr>
	<td align=center width=100%>
		<div id="pxbutton"><a href="javascript: returnMe(); void(0);">Return</a></div>
	</td>
</tr>
</table>
