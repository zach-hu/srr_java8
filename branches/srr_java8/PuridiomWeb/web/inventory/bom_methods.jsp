	...
	<td width=680px align=center>
		...
		<tr>
			<td width=100% align=center valign=top>
				...
				<tr>
					<td class=browseHdr height=18px nowrap>&nbsp;Methods for Parent Item "<%=invItemNumber%>"</td>
				</tr>
				<tr>
					<td class=browseRow>
						...
						<tr>
							...
							<td <%=HtmlWriter.isVisible(oid, "bmm-description")%> align=center valign=bottom width=40%><b><%=DictionaryManager.getLabelsInstance(oid, language).getLabel(oid, "bmm-description", "Description")%></b></td>
...
%>
						<tr>
							...
							<td <%=HtmlWriter.isVisible(oid, "bmm-methodId")%> width=14% align=left nowrap>
								<a href="javascript: viewMethod(<%=i%>);" title="Edit Method"><%=bomMethod.getMethodId()%></a>
							...
							<td <%=HtmlWriter.isVisible(oid, "bmm-description")%> width=40% align=left nowrap><%=HiltonUtility.ckNull(bomMethod.getDescription())%></td>
...
<table border=0 cellpadding=0 cellspacing=0 width=680px>
<tr>
	<td width=50% align=center><a href="javascript: addMethod(); void(0);"><img class=button src="<%=contextPath%>/images/button_add.gif" border=0 alt="Add"></a></td>
...
<!-- Hide script
	...
	function deleteMethod(row) {
		...
		doSubmit('inventory/bom_methods.jsp','BomMethodDelete;BomMethodRetrieveByItem');
	}
