...
<%
	...
	if (s_inv_status == null)
	{
		s_inv_status = (String) request.getAttribute("formStatus");
	}
%>
...
<tsa:hidden name="DocAttachment_docSource" value="INV"/>
<tsa:hidden name="DocAttachment_docPrint" value="N"/>
<tsa:hidden name="returnPage" value="/inventory/inv_line_attachments.jsp"/>
<tsa:hidden name="returnHandler" value="InvItemRetrieveById;DocAttachmentRetrieveByHeader"/>
...
<%	int i_colspan = 1;%>
		<tr>
			...
			<td width=100px><%=headerEncoder.encodeForHTML(s_item_number)%></td>
		</tr>
		<tr>
...
<tr>
	<td valign=top align=center width=100%>
		...
		<tr>
			<td align=center width=50%><div id="pxbutton"><a href="javascript: doSubmit('/inventory/inv_attachment_add.jsp', '--'); void(0);"><tsa:label labelName="add" defaultString="Add" /></a></div></td>
			<td align=center width=50%><div id="pxbutton"><a href="javascript: doSubmit('/inventory/inv_line_attachments.jsp', 'InvItemUpdate;DocAttachmentRetrieveByHeader'); void(0);"><tsa:label labelName="return" defaultString="Return" /></a></div></td>
		</tr>
		</table>
	</td>
</tr>
