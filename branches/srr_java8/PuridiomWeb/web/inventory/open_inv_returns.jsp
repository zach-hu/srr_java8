	...
	<td valign=top width=150px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 valign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12>Inventory Returns Search</div>
			</td>
		</tr>
		</table>
	</td>
...
<tr>
	<td width=680px align=center>
					<TABLE CELLPADDING=2 CELLSPACING=0 BORDER=0 WIDTH=650px>
						...
						<TR>
							<TD align='left' nowrap>Line Number</TD>
							<TD>
								<SELECT NAME="as_catalog" ONCHANGE="setValues();">
									<OPTION value="=">Equal To</OPTION>
									<OPTION value="<">Greater Than</OPTION>
						...
						<TR>
							...
							<TD><INPUT TYPE="TEXT" NAME="status" SIZE=15 MAXLENGTH=30 value="" ONCHANGE="upperCase(this);"></TD>	
						</TR>
						<TR>
						...
						<TR>
							<TD align='left' nowrap>Requested Quantity</TD>
							<TD>
								<SELECT NAME="as_catalog" ONCHANGE="setValues();">
									<OPTION value="=">Equal To</OPTION>
									<OPTION value="<">Greater Than</OPTION>
						...
						<TR>
							<TD align='left' nowrap>Received By</TD>
							<TD>
								<SELECT NAME="as_catalog" ONCHANGE="setValues();">
									<OPTION value="=">Equal To</OPTION>
									<OPTION value="<">Greater Than</OPTION>
						...
						<TR>
							<TD align='left' nowrap>Date Received</TD>
							<TD>
								<SELECT NAME="as_catalog" ONCHANGE="setValues();">
									<OPTION value="=">Equal To</OPTION>
									<OPTION value="<">Greater Than</OPTION>
