...
<tr>
	<td width=100% align=center valign=top><br><b>Printing Assigned Requisitions... Please wait.</b><br><br><br><img src="<%=contextPath%>/images/processing.gif" border=1 width=200px height=15px></td>
</tr>
</table>
