...
<tr>
	<td width=100% align=center valign=top><br><b>Printing Invoices... Please wait.</b><br><br><br><img src="<%=contextPath%>/images/processing.gif" border=1 width=200px height=15px></td>
</tr>
</table>
...
<!--  hide script from old browsers
	...
	{
	  popupUrl = "";
	  popupHandler = "PrintApprovedPdfInvoices";
