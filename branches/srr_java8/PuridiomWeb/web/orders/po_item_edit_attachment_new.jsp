...
<%
	...
	String	docTitle = "";
	docTitle = HiltonUtility.ckNull((String) request.getAttribute("DocAttachment_edit_docTitle"));
	String	s_po_doc_ic = "";
	if (request.getAttribute("DocAttachment_edit_docIc")!=null){s_po_doc_ic = (String)request.getAttribute("DocAttachment_edit_docIc");}
%>
...
<input type="hidden" name="DocAttachment_icHeader" value="<%=s_ic_po_header%>">
<input type="hidden" name="DocAttachment_icLine" value="<%=s_ic_po_line%>">
<input type="hidden" name="DocAttachment_docIc" value="">
<input type="hidden" name="DocAttachment_docSource" value="POL">
<input type="hidden" name="DocAttachment_docPrint" value="N">
<input type="hidden" name="returnPage" value="/orders/po_line_attachments.jsp">
<input type="hidden" name="returnHandler" value="DocAttachmentRetrieveByLine">
...
<tsa:hidden name="DocAttachment_edit_docIc" value="<%=s_po_doc_ic%>"/>
...
<tr>
	<td valign=top align=center width=100%>
		...
		<tr>
			...
			<td><input type=text name="DocAttachment_docTitle" value="<%=docTitle%>" size=60 maxLength=60></td>
		</tr>
		<tr>
...
<!--			<td align=center width=50%><div id="pxbutton"><a href="javascript: doSubmit('/orders/po_line_attachment_add.jsp', '--'); void(0);">Add</a></div></td>-->
			<td align=center width=50%><div id="pxbutton"><a href="javascript: doSubmit('/orders/po_line_edit_attachment_add.jsp', '--'); void(0);">Add</a></div></td>
