...
<%
  ...
  s_recsteps = "recsteps_" + "po" ; // s_rec_type.toLowerCase();
...
<tr>
	<td colspan="3" class="processOff" align="center">
		...
		<tr>
		<%	if (s_current_page.equals("/receipts/rec_review.jsp") &&
				s_rec_status.compareTo(DocumentStatus.RCV_INPROGRESS) == 0 &&
				(receiptMethod.equals("ReceiveByPackage") || receiptMethod.equals("ReceiveFromNothing") || receiptMethod.equals("ReceiveByOrder")) &&
				!HiltonUtility.isEmpty(s_rec_number)) { %>
			<td align=center><div id="forward_link" style="visibility: visible;"><a href="javascript: validateRec('FORWARD'); void(0);"><img class=button src="<%=contextPath%>/images/button_forward.gif" border=0 alt="Forward"></a></div></td>
		<%	} else if (s_current_page.equals("/receipts/rec_review.jsp") &&
				s_rec_status.compareTo(DocumentStatus.RCV_PENDINGFINALIZATION) == 0 &&
				receiptMethod.equals("FinalizeReceipt") &&
				!HiltonUtility.isEmpty(s_rec_number)) { %>
			<td align=center><div id="forward_link" style="visibility: visible;"><a href="javascript: validateRec('FINALIZE'); void(0);"><img class=button src="<%=contextPath%>/images/button_finalize.gif" border=0 alt="Save"></a></div></td>
		<%	} else if (s_rec_status.compareTo(DocumentStatus.RCV_INPROGRESS) == 0 ||
			...
			<td align=center><a href="javascript: recSave(); void(0);"><img class=button src="<%=contextPath%>/images/button_save.gif" border=0 alt="Save"></a></td>
		<%	} %>
		</tr>
		</table>
	</td>
