...
<tsa:tr>
	...
	<tsa:td valign="bottom" height="30px" width="*">
		...
		<tsa:tr>
			...
			<tsa:label labelName="requisitionNumber" defaultString="Requisition #" />:</b>
			</tsa:td>
...
<%	}	%>
		...
		<tsa:tr>
			<tsa:td align="center" width="50%"><div id="pxbutton"><a href="javascript: option=0; doSubmit('/requests/ins_attachment_add.jsp', '--'); void(0);"><tsa:label labelName="req-Add" defaultString="Add" /></a></div></tsa:td>
			<tsa:td align="center" width="50%"><div id="pxbutton"><a href="javascript: option=1; doSubmit('/requests/ins_attachments.jsp', 'DocAttachmentRetrieveByHeader'); void(0);"><tsa:label labelName="req-Return" defaultString="Return" /></a></div></tsa:td>
		</tsa:tr>
		</table>
	</tsa:td>
</tsa:tr>
