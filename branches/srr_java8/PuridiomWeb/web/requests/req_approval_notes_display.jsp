<%
	List approvalLogListOrderedByUserId = (List)request.getAttribute("approvalLogListOrderedByUserId");
	String lastApproverName="";
	if (!(approvalLogListOrderedByUserId == null))
	{%>
		<br>
...
<%
		for (Iterator iterator = approvalLogListOrderedByUserId.iterator(); iterator.hasNext();)
		{
