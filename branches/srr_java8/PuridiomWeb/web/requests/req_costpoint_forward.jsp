...
<%try{
	...
	String s_req_type = reqHeader.getRequisitionType();
	String s_form_number = reqHeader.getRequisitionNumber();
	if (reqHeader.getIcReqHeader() == null) System.out.println("reqHeader.icReqHeader is null");
	...
	try {
		...
		osw.write("REQUISITION_NUMBER=" + s_header_ic);
		osw.write("&PORT_SELECTION=apvoucherinsert");
		osw.write("&Type=AP");
		osw.flush();
		osw.close();
...
<tsa:hidden name="ReqLine_icReqHeader" value="<%= reqHeader.getIcReqHeader() %>"/>
<tsa:hidden name="Account_icHeader" value="<%= reqHeader.getIcReqHeader() %>"/>
<tsa:hidden name="Account_accountType" value="RQH"/>
<tsa:hidden name="ReqHeader_status" value="<%=reqHeader.getStatus()%>"/>
<tsa:hidden name="ReqHeader_reqType" value="<%=reqHeader.getRequisitionType()%>"/>
<tsa:hidden name="reqaction" value=""/>
<tsa:hidden name="reqForwardOption" value=""/>
...
<tr>
	<td align="center">
		<font class="formType"><%=RequisitionType.toString(reqHeader.getRequisitionType(), oid)%> </font><font class="hdr12">#<%=headerEncoder.encodeForHTML(s_form_number)%></font>
	</td>
</tr>
<tr><td><br></td></tr>
<tr>
