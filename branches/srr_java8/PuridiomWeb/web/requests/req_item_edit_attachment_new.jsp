...
<%
	...
	String bd_ic_po_line = HiltonUtility.ckNull((String) request.getAttribute("RequisitionLine_icReqLine"));
	String bd_ic_po_line_req = HiltonUtility.ckNull((String) request.getAttribute("RequisitionLine_icReqLine"));
	String bd_line_number = HiltonUtility.ckNull((String) request.getAttribute("RequisitionLine_lineNumber"));
	String s_po_line_status = HiltonUtility.ckNull((String) request.getAttribute("RequisitionLine_status"));
	String s_line_count = HiltonUtility.ckNull((String) request.getAttribute("lineCount"));
...
<!--			<td align=center><b>Print with Requisition</b></td>-->
		...
		<tsa:tr>
			<tsa:td align="center" width="50%"><div id="pxbutton"><a href="javascript: doSubmit('/requests/req_line_edit_attachment_add.jsp', '--'); void(0);"><tsa:label labelName="req-add" defaultString="Add"/></a></div></tsa:td>
			<tsa:td align="center" width="50%"><div id="pxbutton"><a href="javascript: doSubmit('/requests/req_line_attachments.jsp', 'DocAttachmentRetrieveByLine'); void(0);"><tsa:label labelName="req-return" defaultString="Return"/></a></div></tsa:td>
		</tsa:tr>
		</table>
	</tsa:td>
</tsa:tr>
