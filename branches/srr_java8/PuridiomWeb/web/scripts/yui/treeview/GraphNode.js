 ...
 */
YAHOO.widget.GraphNode = function(oData, oParent, expanded, checked, _graphId) {
    ...
    if (oData) {
        ...
        this.setUpGraphId(_graphId);
    }

};

YAHOO.extend(YAHOO.widget.GraphNode, YAHOO.widget.TextNode, {
    ...
    setUpGraphId: function(_graphId){
    ...
    {
        return "ygtvcheck" + this.index + "_" + this.checkState;
    },
