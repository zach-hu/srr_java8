...
<tsa:hidden name="returnPage" value="/rfq/supplier_attachments.jsp"/>
	...
	<td valign=top width=135px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 valign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12>Add Response Document</div>
			</td>
		</tr>
		</table>
	</td>
...
<tr>
	<td valign=top align=center width=100%>	
		...
		<tr>
			<td align=center width=50%><a href="javascript: doSubmit('/rfq/supplier_attachment_add.jsp', '--'); void(0);"><img src="<%=contextPath%>/supplierportal/images/button_add.gif" border=0 class=button></a></td>
			<td align=center width=50%><a href="javascript: doSubmit('/rfq/supplier_attachments.jsp', 'VendorDocumentRetrieveByVendor'); void(0);"><img src="<%=contextPath%>/supplierportal/images/button_return.gif" border=0 class=button></a></td>
		</tr>
		</table>
	</td>
</tr>
	...
	function validateForm() {
		...
		if (handler.indexOf("--") >= 0) {
			...
			if ( isEmpty(title) && isEmpty(doc) ) {
				...
				frm.action =" <%=contextPath%>/supplierportal/PuridiomSupplierPortalDocumentUpload";
