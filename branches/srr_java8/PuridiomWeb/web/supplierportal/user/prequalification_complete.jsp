...
<tr>
	<% if (user.isQualified()) {  %>
	<td align=center>
		Thank you.  The profile infomation you provided has been updated.
		   To return to the Supplier Options Menu, click
		   the "Continue" button.
	</td>
	<% } else {  %>
	<td align=center>
		Thank you.  The pre-qualification information you provided has
		   been submitted for review.  You may update this information at
