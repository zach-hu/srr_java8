	...
	<td valign=top width=135px height=30px>
		...
		<tr>
			<td nowrap class=hdr12 valign=middle>
				<div style="margin-left:10px; margin-right:10px" class=hdr12>Credit Card Billing Information</div>
			</td>
		</tr>
		</table>
	</td>
...
<%	}%>
				...
				<tr>
					<td width=50% align=center>
						<div id="pxbutton"><a href="javascript: updateCCInfo(); void(0);">Save</a></div>
					</td>
					<td width=50% align=center>
						<div id="pxbutton"><a href="javascript: cancelUpdate(); void(0);">Cancel</a></div>
					</td>
				</tr>
				</table>
			</td>
