...
public class Extrinsic implements Serializable
{
	...
	public Extrinsic(String name, Object content)
	{
		this.name = name;
	...
	private void setAttributes(Element extrinsicElement, Extrinsic extrinsicObject)
	{
		/*
	...
	private void setContent(Element extrinsicElement, Extrinsic extrinsicObject)
	{
		/*
		 * ANY
		 */

		extrinsicElement.setText(extrinsicObject.getContent().toString());
	}
}
